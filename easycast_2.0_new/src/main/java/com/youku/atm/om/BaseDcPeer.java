 ...
 *
 */
public abstract class BaseDcPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(DcMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(DcMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(DcMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(DcMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Dc> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Dc row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Dc obj = (Dc) cls.newInstance();
            DcPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setTargetDate(row.getValue(offset + 1).asUtilDate());
            obj.setCpm(row.getValue(offset + 2).asInt());
            obj.setCpc(row.getValue(offset + 3).asInt());
            obj.setCpv(row.getValue(offset + 4).asInt());
            obj.setCpp(row.getValue(offset + 5).asInt());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Dc> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Dc> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Dc> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Dc> results = new ArrayList<Dc>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(DcPeer.row2Object(row, 1,
                DcPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Dc> doSelect(Dc obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Dc obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Dc obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Dc obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Dc) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Dc obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Dc) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Dc obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Dc) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Dc obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Dc obj )
    {
    ...
    public static Criteria buildSelectCriteria( Dc obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static Dc retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Dc retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Dc retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        Dc retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Dc retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Dc> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Dc> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<Dc> retVal = null;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Dc> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Dc> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Dc>();
        }
        else
        {
            Criteria criteria = new Criteria();
