 ...
 *
  */
public class HcastCpmMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.youku.atm.om.map.HcastCpmMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("hcast_cpm");
        TableMap tMap = dbMap.getTable("hcast_cpm");
        tMap.setJavaName("HcastCpm");
        tMap.setOMClass( com.youku.atm.om.HcastCpm.class );
        tMap.setPeerClass( com.youku.atm.om.HcastCpmPeer.class );
        tMap.setDescription("");
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("atm");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("hcast_cpm_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("hcast_cpm");
        }
