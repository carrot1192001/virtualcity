 ...
 *
 */
public abstract class BaseRtbIdeaUrlPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(RtbIdeaUrlMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(RtbIdeaUrlMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "rtb_idea_url";

        ID = "rtb_idea_url.id";
        URL = "rtb_idea_url.url";
        DSP_ID = "rtb_idea_url.dsp_id";
        STARTTIME = "rtb_idea_url.startTime";
        STATUS = "rtb_idea_url.status";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(RtbIdeaUrlMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(RtbIdeaUrlMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RtbIdeaUrl> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static RtbIdeaUrl row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            RtbIdeaUrl obj = (RtbIdeaUrl) cls.newInstance();
            RtbIdeaUrlPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setDspId(row.getValue(offset + 2).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RtbIdeaUrl> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RtbIdeaUrl> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RtbIdeaUrl> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<RtbIdeaUrl> results = new ArrayList<RtbIdeaUrl>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(RtbIdeaUrlPeer.row2Object(row, 1,
                RtbIdeaUrlPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RtbIdeaUrl> doSelect(RtbIdeaUrl obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(RtbIdeaUrl obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(RtbIdeaUrl obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(RtbIdeaUrl obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(RtbIdeaUrl) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(RtbIdeaUrl obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(RtbIdeaUrl) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(RtbIdeaUrl obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(RtbIdeaUrl) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(RtbIdeaUrl obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( RtbIdeaUrl obj )
    {
    ...
    public static Criteria buildSelectCriteria( RtbIdeaUrl obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ID, obj.getId());
            criteria.add(URL, obj.getUrl());
     ...
     */
    public static RtbIdeaUrl retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static RtbIdeaUrl retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static RtbIdeaUrl retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        RtbIdeaUrl retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static RtbIdeaUrl retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<RtbIdeaUrl> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RtbIdeaUrl> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<RtbIdeaUrl> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<RtbIdeaUrl> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<RtbIdeaUrl> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<RtbIdeaUrl>();
        }
        else
        {
            Criteria criteria = new Criteria();
