 ...
 *
 */
public abstract class BaseVhideaCpmPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(VhideaCpmMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(VhideaCpmMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "vhidea_cpm";

        ID = "vhidea_cpm.id";
        IDEA_ID = "vhidea_cpm.idea_id";
        CPM = "vhidea_cpm.cpm";
        CPC = "vhidea_cpm.cpc";
        RATE = "vhidea_cpm.rate";
        TARGET_DATE = "vhidea_cpm.target_date";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(VhideaCpmMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(VhideaCpmMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhideaCpm> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static VhideaCpm row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            VhideaCpm obj = (VhideaCpm) cls.newInstance();
            VhideaCpmPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setTargetDate(row.getValue(offset + 5).asUtilDate());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhideaCpm> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhideaCpm> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhideaCpm> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<VhideaCpm> results = new ArrayList<VhideaCpm>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(VhideaCpmPeer.row2Object(row, 1,
                VhideaCpmPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhideaCpm> doSelect(VhideaCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(VhideaCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(VhideaCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(VhideaCpm obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(VhideaCpm) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(VhideaCpm obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(VhideaCpm) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(VhideaCpm obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(VhideaCpm) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(VhideaCpm obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( VhideaCpm obj )
    {
    ...
    public static Criteria buildSelectCriteria( VhideaCpm obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static VhideaCpm retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VhideaCpm retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VhideaCpm retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        VhideaCpm retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VhideaCpm retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<VhideaCpm> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhideaCpm> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<VhideaCpm> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhideaCpm> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<VhideaCpm> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<VhideaCpm>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of VhideaCpm objects pre-filled with their
     * Idea objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in VhideaCpmPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<VhideaCpm> doSelectJoinIdea(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<VhideaCpm> doSelectJoinIdea(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        VhideaCpmPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        IdeaPeer.addSelectColumns(criteria);

        criteria.addJoin(VhideaCpmPeer.IDEA_ID,
            IdeaPeer.ID);
        ...
        List<VhideaCpm> results = new ArrayList<VhideaCpm>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = VhideaCpmPeer.getOMClass();
            VhideaCpm obj1 = (VhideaCpm) VhideaCpmPeer
            ...
            {
                VhideaCpm temp_obj1 =  results.get(j);
                Idea temp_obj2 = (Idea) temp_obj1.getIdea();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addVhideaCpm(obj1);
                    break;
                }
            }
            if (newObject)
