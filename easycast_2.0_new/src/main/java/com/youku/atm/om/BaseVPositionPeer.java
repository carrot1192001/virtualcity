 ...
 *
 */
public abstract class BaseVPositionPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(VPositionMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(VPositionMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the ad_seq field */
    public static final String AD_SEQ;
    ...
    static
    {
        ...
        ID = "v_position.id";
        PARENT_ID = "v_position.parent_id";
        NAME = "v_position.name";
        MANAGE_TYPE = "v_position.manage_type";
        PS = "v_position.ps";
        AD_SEQ = "v_position.ad_seq";
        ...
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(VPositionMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(VPositionMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VPosition> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(AD_SEQ);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static VPosition row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            VPosition obj = (VPosition) cls.newInstance();
            VPositionPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setManageType(row.getValue(offset + 3).asString());
            obj.setPs(row.getValue(offset + 4).asInt());
            obj.setAdSeq(row.getValue(offset + 5).asInt());
            obj.setType(row.getValue(offset + 6).asInt());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VPosition> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VPosition> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VPosition> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<VPosition> results = new ArrayList<VPosition>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(VPositionPeer.row2Object(row, 1,
                VPositionPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VPosition> doSelect(VPosition obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(VPosition obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(VPosition obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(VPosition obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(VPosition) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(VPosition obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(VPosition) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(VPosition obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(VPosition) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(VPosition obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( VPosition obj )
    {
        ...
        criteria.add(AD_SEQ, obj.getAdSeq());
    ...
    public static Criteria buildSelectCriteria( VPosition obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ID, obj.getId());
            criteria.add(PARENT_ID, obj.getParentId());
     ...
     */
    public static VPosition retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VPosition retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VPosition retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        VPosition retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VPosition retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<VPosition> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VPosition> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<VPosition> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VPosition> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<VPosition> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<VPosition>();
        }
        else
        {
            Criteria criteria = new Criteria();
