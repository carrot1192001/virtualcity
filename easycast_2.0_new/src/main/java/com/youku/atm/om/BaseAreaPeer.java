 ...
 *
 */
public abstract class BaseAreaPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(AreaMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(AreaMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(AreaMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(AreaMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Area> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Area row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Area obj = (Area) cls.newInstance();
            AreaPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setLevel(row.getValue(offset + 2).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Area> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Area> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Area> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Area> results = new ArrayList<Area>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(AreaPeer.row2Object(row, 1,
                AreaPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Area> doSelect(Area obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Area obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Area obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Area obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Area) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Area obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Area) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Area obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Area) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Area obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Area obj )
    {
    ...
    public static Criteria buildSelectCriteria( Area obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ID, obj.getId());
            criteria.add(PARENT_ID, obj.getParentId());
     ...
     */
    public static Area retrieveByPK(String pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Area retrieveByPK(String pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Area retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        Area retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Area retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Area> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Area> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<Area> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Area> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Area> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Area>();
        }
        else
        {
            Criteria criteria = new Criteria();
