 ...
 *
 */
public abstract class BaseProtectPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(ProtectMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(ProtectMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the manage_type field */
    public static final String MANAGE_TYPE;
    /** the column name for the positions field */
    ...
    static
    {
        ...
        ID = "protect.id";
        NAME = "protect.name";
        MANAGE_TYPE = "protect.manage_type";
        POSITIONS = "protect.positions";
        PARENT = "protect.parent";
        PRIORITY = "protect.priority";
        RESOURCE_ID = "protect.resource_id";
        COLOR = "protect.color";
        STARTTIME = "protect.starttime";
        ENDTIME = "protect.endtime";
        STATUS = "protect.status";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(ProtectMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(ProtectMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Protect> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(MANAGE_TYPE);
        criteria.addSelectColumn(POSITIONS);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Protect row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Protect obj = (Protect) cls.newInstance();
            ProtectPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setManageType(row.getValue(offset + 2).asString());
            obj.setPositions(row.getValue(offset + 3).asString());
            obj.setParent(row.getValue(offset + 4).asInt());
            obj.setPriority(row.getValue(offset + 5).asInt());
            obj.setResourceId(row.getValue(offset + 6).asInt());
            obj.setColor(row.getValue(offset + 7).asInt());
            obj.setStarttime(row.getValue(offset + 8).asUtilDate());
            obj.setEndtime(row.getValue(offset + 9).asUtilDate());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Protect> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Protect> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Protect> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Protect> results = new ArrayList<Protect>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(ProtectPeer.row2Object(row, 1,
                ProtectPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Protect> doSelect(Protect obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Protect obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Protect obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Protect obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Protect) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Protect obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Protect) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Protect obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Protect) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Protect obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Protect obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        criteria.add(ID, obj.getId());
        criteria.add(NAME, obj.getName());
        criteria.add(MANAGE_TYPE, obj.getManageType());
        criteria.add(POSITIONS, obj.getPositions());
    ...
    public static Criteria buildSelectCriteria( Protect obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ID, obj.getId());
            criteria.add(NAME, obj.getName());
     ...
     */
    public static Protect retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Protect retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Protect retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        Protect retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Protect retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Protect> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Protect> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<Protect> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Protect> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Protect> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Protect>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of Protect objects pre-filled with their
     * Resource objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ProtectPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<Protect> doSelectJoinResource(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<Protect> doSelectJoinResource(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        ProtectPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        ResourcePeer.addSelectColumns(criteria);

        criteria.addJoin(ProtectPeer.RESOURCE_ID,
            ResourcePeer.ID);
        ...
        List<Protect> results = new ArrayList<Protect>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = ProtectPeer.getOMClass();
            Protect obj1 = (Protect) ProtectPeer
