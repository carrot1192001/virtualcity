 ...
 *
 */
public abstract class BaseAdOrderPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(AdOrderMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(AdOrderMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the sub_industry_id field */
    public static final String SUB_INDUSTRY_ID;
    /** the column name for the category_id field */
    public static final String CATEGORY_ID;
    /** the column name for the marketing_type field */
    public static final String MARKETING_TYPE;
    ...
    static
    {
        ...
        ID = "ad_order.id";
        NAME = "ad_order.name";
        CUSTOM_ID = "ad_order.custom_id";
        CUSTOM_NAME = "ad_order.custom_name";
        TYPE = "ad_order.type";
        UPDATE_TIME = "ad_order.update_time";
        STATUS = "ad_order.status";
        INDUSTRY_ID = "ad_order.industry_id";
        SUB_INDUSTRY_ID = "ad_order.sub_industry_id";
        CATEGORY_ID = "ad_order.category_id";
        MARKETING_TYPE = "ad_order.marketing_type";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(AdOrderMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(AdOrderMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdOrder> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(CUSTOM_ID);
        criteria.addSelectColumn(CUSTOM_NAME);
        ...
        criteria.addSelectColumn(SUB_INDUSTRY_ID);
        criteria.addSelectColumn(CATEGORY_ID);
        criteria.addSelectColumn(MARKETING_TYPE);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static AdOrder row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            AdOrder obj = (AdOrder) cls.newInstance();
            AdOrderPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setCustomId(row.getValue(offset + 2).asInt());
            obj.setCustomName(row.getValue(offset + 3).asString());
            ...
            obj.setIndustryId(row.getValue(offset + 7).asInt());
            obj.setSubIndustryId(row.getValue(offset + 8).asInt());
            obj.setCategoryId(row.getValue(offset + 9).asInt());
            obj.setMarketingType(row.getValue(offset + 10).asInt());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdOrder> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdOrder> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdOrder> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<AdOrder> results = new ArrayList<AdOrder>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(AdOrderPeer.row2Object(row, 1,
                AdOrderPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdOrder> doSelect(AdOrder obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(AdOrder obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(AdOrder obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(AdOrder obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(AdOrder) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(AdOrder obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(AdOrder) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(AdOrder obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(AdOrder) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(AdOrder obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( AdOrder obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        criteria.add(ID, obj.getId());
        criteria.add(NAME, obj.getName());
        criteria.add(CUSTOM_ID, obj.getCustomId());
        criteria.add(CUSTOM_NAME, obj.getCustomName());
        ...
        criteria.add(SUB_INDUSTRY_ID, obj.getSubIndustryId());
        criteria.add(CATEGORY_ID, obj.getCategoryId());
        criteria.add(MARKETING_TYPE, obj.getMarketingType());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( AdOrder obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ID, obj.getId());
            criteria.add(NAME, obj.getName());
     ...
     */
    public static AdOrder retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static AdOrder retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static AdOrder retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        AdOrder retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static AdOrder retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<AdOrder> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdOrder> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<AdOrder> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdOrder> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<AdOrder> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<AdOrder>();
        }
        else
        {
            Criteria criteria = new Criteria();
