 ...
 *
 */
public abstract class BaseCastUserPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(CastUserMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(CastUserMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "cast_user";

        ID = "cast_user.id";
        CAST_ID = "cast_user.cast_id";
        DIRECT_NAME = "cast_user.direct_name";
        DIRECT_VALUE = "cast_user.direct_value";
        IS_POSITIVE = "cast_user.is_positive";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(CastUserMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(CastUserMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastUser> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static CastUser row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            CastUser obj = (CastUser) cls.newInstance();
            CastUserPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastUser> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastUser> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastUser> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<CastUser> results = new ArrayList<CastUser>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(CastUserPeer.row2Object(row, 1,
                CastUserPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastUser> doSelect(CastUser obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastUser obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastUser obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastUser obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(CastUser) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastUser obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(CastUser) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastUser obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(CastUser) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastUser obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( CastUser obj )
    {
    ...
    public static Criteria buildSelectCriteria( CastUser obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static CastUser retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastUser retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastUser retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        CastUser retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastUser retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<CastUser> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastUser> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<CastUser> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastUser> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<CastUser> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<CastUser>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of CastUser objects pre-filled with their
     * AdCast objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CastUserPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastUser> doSelectJoinAdCast(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastUser> doSelectJoinAdCast(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        CastUserPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        AdCastPeer.addSelectColumns(criteria);

        criteria.addJoin(CastUserPeer.CAST_ID,
            AdCastPeer.ID);
        ...
        List<CastUser> results = new ArrayList<CastUser>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = CastUserPeer.getOMClass();
            CastUser obj1 = (CastUser) CastUserPeer
            ...
            {
                CastUser temp_obj1 =  results.get(j);
                AdCast temp_obj2 = (AdCast) temp_obj1.getAdCast();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addCastUser(obj1);
                    break;
                }
            }
            if (newObject)
