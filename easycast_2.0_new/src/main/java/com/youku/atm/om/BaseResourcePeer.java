    ...
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(ResourceMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(ResourceMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(ResourceMapBuilder.CLASS_NAME);
            }
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setLevel(row.getValue(offset + 3).asInt());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
