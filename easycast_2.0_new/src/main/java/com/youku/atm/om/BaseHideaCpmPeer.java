 ...
 *
 */
public abstract class BaseHideaCpmPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(HideaCpmMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(HideaCpmMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "hidea_cpm";

        ID = "hidea_cpm.id";
        IDEA_ID = "hidea_cpm.idea_id";
        CPM = "hidea_cpm.cpm";
        CPC = "hidea_cpm.cpc";
        RATE = "hidea_cpm.rate";
        TARGET_DATE = "hidea_cpm.target_date";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(HideaCpmMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(HideaCpmMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HideaCpm> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static HideaCpm row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            HideaCpm obj = (HideaCpm) cls.newInstance();
            HideaCpmPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HideaCpm> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HideaCpm> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HideaCpm> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<HideaCpm> results = new ArrayList<HideaCpm>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(HideaCpmPeer.row2Object(row, 1,
                HideaCpmPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HideaCpm> doSelect(HideaCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(HideaCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(HideaCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(HideaCpm obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(HideaCpm) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(HideaCpm obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(HideaCpm) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(HideaCpm obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(HideaCpm) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(HideaCpm obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( HideaCpm obj )
    {
    ...
    public static Criteria buildSelectCriteria( HideaCpm obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static HideaCpm retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static HideaCpm retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static HideaCpm retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        HideaCpm retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static HideaCpm retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<HideaCpm> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HideaCpm> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<HideaCpm> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HideaCpm> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<HideaCpm> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<HideaCpm>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of HideaCpm objects pre-filled with their
     * Idea objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in HideaCpmPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<HideaCpm> doSelectJoinIdea(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<HideaCpm> doSelectJoinIdea(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        HideaCpmPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        IdeaPeer.addSelectColumns(criteria);

        criteria.addJoin(HideaCpmPeer.IDEA_ID,
            IdeaPeer.ID);
        ...
        List<HideaCpm> results = new ArrayList<HideaCpm>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = HideaCpmPeer.getOMClass();
            HideaCpm obj1 = (HideaCpm) HideaCpmPeer
            ...
            {
                HideaCpm temp_obj1 =  results.get(j);
                Idea temp_obj2 = (Idea) temp_obj1.getIdea();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addHideaCpm(obj1);
                    break;
                }
            }
            if (newObject)
