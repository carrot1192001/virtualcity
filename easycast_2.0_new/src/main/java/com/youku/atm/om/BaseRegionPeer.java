    ...
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(RegionMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(RegionMapBuilder.CLASS_NAME);
    }
    ...
    public static final String PROVINCE_ID;
    ...
    /** the column name for the geoid field */
    ...
    static
    {
        ...
        END_IP = "region.end_ip";
        GEOID = "region.geoid";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(RegionMapBuilder.CLASS_NAME);
            }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Region> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(CITY_ID);
        criteria.addSelectColumn(PROVINCE_ID);
        criteria.addSelectColumn(START_IP);
        criteria.addSelectColumn(END_IP);
        criteria.addSelectColumn(GEOID);
    }
        ...
        throws TorqueException
    {
        try
        {
            ...
            RegionPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setCityId(row.getValue(offset + 1).asString());
            obj.setProvinceId(row.getValue(offset + 2).asString());
            obj.setStartIp(row.getValue(offset + 3).asString());
            obj.setEndIp(row.getValue(offset + 4).asString());
            obj.setGeoid(row.getValue(offset + 5).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Region> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Region> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Region> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Region> results = new ArrayList<Region>(records.size());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Region> doSelect(Region obj) throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Region obj )
    {
        ...
        criteria.add(CITY_ID, obj.getCityId());
        criteria.add(PROVINCE_ID, obj.getProvinceId());
        criteria.add(START_IP, obj.getStartIp());
        criteria.add(END_IP, obj.getEndIp());
        criteria.add(GEOID, obj.getGeoid());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( Region obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Region retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        ...
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        ...
        List<Region> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Region> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Region> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Region> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Region>();
        }
        else
        {
            Criteria criteria = new Criteria();
