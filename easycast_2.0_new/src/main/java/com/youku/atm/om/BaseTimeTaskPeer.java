 ...
 *
 */
public abstract class BaseTimeTaskPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(TimeTaskMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(TimeTaskMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the interface_name field */
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "time_task";

        ID = "time_task.id";
        NAME = "time_task.name";
        PERIOD = "time_task.period";
        IP = "time_task.ip";
        INTERFACE_NAME = "time_task.interface_name";
        PARAMS = "time_task.params";
        STATUS = "time_task.status";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(TimeTaskMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(TimeTaskMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TimeTask> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(PERIOD);
        criteria.addSelectColumn(IP);
        criteria.addSelectColumn(INTERFACE_NAME);
        criteria.addSelectColumn(PARAMS);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static TimeTask row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            TimeTask obj = (TimeTask) cls.newInstance();
            TimeTaskPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setPeriod(row.getValue(offset + 2).asString());
            obj.setIp(row.getValue(offset + 3).asString());
            obj.setInterfaceName(row.getValue(offset + 4).asString());
            obj.setParams(row.getValue(offset + 5).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TimeTask> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TimeTask> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TimeTask> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<TimeTask> results = new ArrayList<TimeTask>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(TimeTaskPeer.row2Object(row, 1,
                TimeTaskPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TimeTask> doSelect(TimeTask obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TimeTask obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TimeTask obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TimeTask obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(TimeTask) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(TimeTask obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(TimeTask) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(TimeTask obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(TimeTask) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(TimeTask obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( TimeTask obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(ID, obj.getId());
        criteria.add(NAME, obj.getName());
        criteria.add(PERIOD, obj.getPeriod());
        criteria.add(IP, obj.getIp());
        criteria.add(INTERFACE_NAME, obj.getInterfaceName());
        criteria.add(PARAMS, obj.getParams());
        criteria.add(STATUS, obj.getStatus());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( TimeTask obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static TimeTask retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TimeTask retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TimeTask retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        TimeTask retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static TimeTask retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<TimeTask> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TimeTask> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<TimeTask> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<TimeTask> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<TimeTask> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<TimeTask>();
        }
        else
        {
            Criteria criteria = new Criteria();
