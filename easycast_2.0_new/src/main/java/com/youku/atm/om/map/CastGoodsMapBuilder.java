 ...
 *
  */
public class CastGoodsMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.youku.atm.om.map.CastGoodsMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("cast_goods");
        TableMap tMap = dbMap.getTable("cast_goods");
        tMap.setJavaName("CastGoods");
        tMap.setOMClass( com.youku.atm.om.CastGoods.class );
        tMap.setPeerClass( com.youku.atm.om.CastGoodsPeer.class );
        tMap.setDescription("");
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("atm");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("cast_goods_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("cast_goods");
        }
