 ...
 *
  */
public class CastPaidMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.youku.atm.om.map.CastPaidMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("cast_paid");
        TableMap tMap = dbMap.getTable("cast_paid");
        tMap.setJavaName("CastPaid");
        tMap.setOMClass( com.youku.atm.om.CastPaid.class );
        tMap.setPeerClass( com.youku.atm.om.CastPaidPeer.class );
        tMap.setDescription("");
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("atm");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("cast_paid_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("cast_paid");
        }
