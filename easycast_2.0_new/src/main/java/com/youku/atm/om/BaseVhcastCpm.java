 ...
 * extended all references should be to VhcastCpm
 */
public abstract class BaseVhcastCpm extends BaseObject
{
    /** The Peer class */
    private static final VhcastCpmPeer peer =
        new VhcastCpmPeer();
    ...
    {
        if (name.equals(VhcastCpmPeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(VhcastCpmPeer.CAST_ID))
        {
            return new Integer(getCastId());
        }
        if (name.equals(VhcastCpmPeer.CPM))
        {
            return new Integer(getCpm());
        }
        if (name.equals(VhcastCpmPeer.CPC))
        {
            return new Integer(getCpc());
        }
        if (name.equals(VhcastCpmPeer.LUN))
        {
            return getLun();
        }
        if (name.equals(VhcastCpmPeer.PERCENT))
        {
            return new Integer(getPercent());
        }
        if (name.equals(VhcastCpmPeer.TARGET_DATE))
        {
            return getTargetDate();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (VhcastCpmPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (VhcastCpmPeer.CAST_ID.equals(name))
        {
            return setByName("CastId", value);
        }
      if (VhcastCpmPeer.CPM.equals(name))
        {
            return setByName("Cpm", value);
        }
      if (VhcastCpmPeer.CPC.equals(name))
        {
            return setByName("Cpc", value);
        }
      if (VhcastCpmPeer.LUN.equals(name))
        {
            return setByName("Lun", value);
        }
      if (VhcastCpmPeer.PERCENT.equals(name))
        {
            return setByName("Percent", value);
        }
      if (VhcastCpmPeer.TARGET_DATE.equals(name))
        {
    ...
    {
        save(VhcastCpmPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    VhcastCpmPeer.doInsert((VhcastCpm) this, con);
                    setNew(false);
                }
                else
                {
                    VhcastCpmPeer.doUpdate((VhcastCpm) this, con);
                }
            }
     ...
     */
    public VhcastCpm copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public VhcastCpm copy(Connection con) throws TorqueException
    {
     ...
     */
    public VhcastCpm copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new VhcastCpm(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public VhcastCpm copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new VhcastCpm(), deepcopy, con);
    }
     ...
     */
    protected VhcastCpm copyInto(VhcastCpm copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected VhcastCpm copyInto(VhcastCpm copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected VhcastCpm copyInto(VhcastCpm copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected VhcastCpm copyInto(VhcastCpm copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setCastId(castId);
        copyObj.setCpm(cpm);
    ...
    {
        return VhcastCpmPeer.getTableMap();
    }

  
    /**
     * Creates a VhcastCpmBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a VhcastCpmBean with the contents of this object
     */
    public VhcastCpmBean getBean()
    {
     ...
     * @return a VhcastCpmBean with the contents of this object
     */
    public VhcastCpmBean getBean(IdentityMap createdBeans)
    {
        VhcastCpmBean result = (VhcastCpmBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new VhcastCpmBean();
    ...
    /**
     * Creates an instance of VhcastCpm with the contents
     * of a VhcastCpmBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the VhcastCpmBean which contents are used to create
     *        the resulting class
     * @return an instance of VhcastCpm with the contents of bean
     */
    public static VhcastCpm createVhcastCpm(VhcastCpmBean bean)
        throws TorqueException
    {
        return createVhcastCpm(bean, new IdentityMap());
    }
    ...
    public static VhcastCpm createVhcastCpm(VhcastCpmBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        VhcastCpm result = (VhcastCpm) createdObjects.get(bean);
        if (result != null)
        {
            // we already have an object for the bean, return it
            return result;
        }
        result = new VhcastCpm();
