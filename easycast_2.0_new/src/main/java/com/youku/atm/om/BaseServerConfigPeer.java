 ...
 *
 */
public abstract class BaseServerConfigPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(ServerConfigMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(ServerConfigMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(ServerConfigMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(ServerConfigMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ServerConfig> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static ServerConfig row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            ServerConfig obj = (ServerConfig) cls.newInstance();
            ServerConfigPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setIp(row.getValue(offset + 1).asString());
            obj.setRole(row.getValue(offset + 2).asInt());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ServerConfig> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ServerConfig> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ServerConfig> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<ServerConfig> results = new ArrayList<ServerConfig>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(ServerConfigPeer.row2Object(row, 1,
                ServerConfigPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ServerConfig> doSelect(ServerConfig obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(ServerConfig obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(ServerConfig obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(ServerConfig obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(ServerConfig) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(ServerConfig obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(ServerConfig) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(ServerConfig obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(ServerConfig) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(ServerConfig obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( ServerConfig obj )
    {
    ...
    public static Criteria buildSelectCriteria( ServerConfig obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static ServerConfig retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static ServerConfig retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static ServerConfig retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static ServerConfig retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<ServerConfig> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ServerConfig> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<ServerConfig> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ServerConfig> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<ServerConfig> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<ServerConfig>();
        }
        else
        {
            Criteria criteria = new Criteria();
