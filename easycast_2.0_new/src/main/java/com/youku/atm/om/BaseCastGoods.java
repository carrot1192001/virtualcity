 ...
 * extended all references should be to CastGoods
 */
public abstract class BaseCastGoods extends BaseObject
{
    /** The Peer class */
    private static final CastGoodsPeer peer =
        new CastGoodsPeer();
    ...
    {
        if (name.equals(CastGoodsPeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(CastGoodsPeer.CAST_ID))
        {
            return new Integer(getCastId());
        }
        if (name.equals(CastGoodsPeer.DIRECT_NAME))
        {
            return getDirectName();
        }
        if (name.equals(CastGoodsPeer.DIRECT_VALUE))
        {
            return getDirectValue();
        }
        if (name.equals(CastGoodsPeer.IS_POSITIVE))
        {
            return new Integer(getIsPositive());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (CastGoodsPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (CastGoodsPeer.CAST_ID.equals(name))
        {
            return setByName("CastId", value);
        }
      if (CastGoodsPeer.DIRECT_NAME.equals(name))
        {
            return setByName("DirectName", value);
        }
      if (CastGoodsPeer.DIRECT_VALUE.equals(name))
        {
            return setByName("DirectValue", value);
        }
      if (CastGoodsPeer.IS_POSITIVE.equals(name))
        {
    ...
    {
        save(CastGoodsPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    CastGoodsPeer.doInsert((CastGoods) this, con);
                    setNew(false);
                }
                else
                {
                    CastGoodsPeer.doUpdate((CastGoods) this, con);
                }
            }
     ...
     */
    public CastGoods copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public CastGoods copy(Connection con) throws TorqueException
    {
     ...
     */
    public CastGoods copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new CastGoods(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public CastGoods copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new CastGoods(), deepcopy, con);
    }
     ...
     */
    protected CastGoods copyInto(CastGoods copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastGoods copyInto(CastGoods copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected CastGoods copyInto(CastGoods copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastGoods copyInto(CastGoods copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setCastId(castId);
        copyObj.setDirectName(directName);
    ...
    {
        return CastGoodsPeer.getTableMap();
    }

  
    /**
     * Creates a CastGoodsBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a CastGoodsBean with the contents of this object
     */
    public CastGoodsBean getBean()
    {
     ...
     * @return a CastGoodsBean with the contents of this object
     */
    public CastGoodsBean getBean(IdentityMap createdBeans)
    {
        CastGoodsBean result = (CastGoodsBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new CastGoodsBean();
    ...
    /**
     * Creates an instance of CastGoods with the contents
     * of a CastGoodsBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the CastGoodsBean which contents are used to create
     *        the resulting class
     * @return an instance of CastGoods with the contents of bean
     */
    public static CastGoods createCastGoods(CastGoodsBean bean)
        throws TorqueException
    {
        return createCastGoods(bean, new IdentityMap());
    }
    ...
    public static CastGoods createCastGoods(CastGoodsBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        CastGoods result = (CastGoods) createdObjects.get(bean);
        if (result != null)
        {
            // we already have an object for the bean, return it
            return result;
        }
        result = new CastGoods();
