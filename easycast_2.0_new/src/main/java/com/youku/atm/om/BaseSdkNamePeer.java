 ...
 *
 */
public abstract class BaseSdkNamePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(SdkNameMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(SdkNameMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        ID = "sdk_name.id";
        NAME = "sdk_name.name";
        STATUS = "sdk_name.status";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(SdkNameMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(SdkNameMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkName> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static SdkName row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            SdkName obj = (SdkName) cls.newInstance();
            SdkNamePeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkName> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkName> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkName> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<SdkName> results = new ArrayList<SdkName>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(SdkNamePeer.row2Object(row, 1,
                SdkNamePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkName> doSelect(SdkName obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SdkName obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SdkName obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SdkName obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(SdkName) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SdkName obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(SdkName) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SdkName obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(SdkName) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SdkName obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( SdkName obj )
    {
    ...
    public static Criteria buildSelectCriteria( SdkName obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static SdkName retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SdkName retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SdkName retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        SdkName retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SdkName retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<SdkName> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkName> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<SdkName> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkName> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<SdkName> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<SdkName>();
        }
        else
        {
            Criteria criteria = new Criteria();
