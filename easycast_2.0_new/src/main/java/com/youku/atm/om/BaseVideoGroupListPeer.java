 ...
 *
 */
public abstract class BaseVideoGroupListPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(VideoGroupListMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(VideoGroupListMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the video_group_id field */
    public static final String VIDEO_GROUP_ID;
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "video_group_list";

        ID = "video_group_list.id";
        TYPE = "video_group_list.type";
        VALUE = "video_group_list.value";
        UPDATE_TIME = "video_group_list.update_time";
        START_TIME = "video_group_list.start_time";
        END_TIME = "video_group_list.end_time";
        VIDEO_GROUP_ID = "video_group_list.video_group_id";
        STATUS = "video_group_list.status";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(VideoGroupListMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(VideoGroupListMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.atm.om.VideoGroupList";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VideoGroupList> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(VIDEO_GROUP_ID);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static VideoGroupList row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            VideoGroupList obj = (VideoGroupList) cls.newInstance();
            VideoGroupListPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setEndTime(row.getValue(offset + 5).asUtilDate());
            obj.setVideoGroupId(row.getValue(offset + 6).asInt());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VideoGroupList> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VideoGroupList> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VideoGroupList> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<VideoGroupList> results = new ArrayList<VideoGroupList>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(VideoGroupListPeer.row2Object(row, 1,
                VideoGroupListPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VideoGroupList> doSelect(VideoGroupList obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(VideoGroupList obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(VideoGroupList obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(VideoGroupList obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(VideoGroupList) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(VideoGroupList obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(VideoGroupList) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(VideoGroupList obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(VideoGroupList) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(VideoGroupList obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( VideoGroupList obj )
    {
        ...
        criteria.add(VIDEO_GROUP_ID, obj.getVideoGroupId());
        criteria.add(STATUS, obj.getStatus());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( VideoGroupList obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ID, obj.getId());
            criteria.add(TYPE, obj.getType());
     ...
     */
    public static VideoGroupList retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VideoGroupList retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VideoGroupList retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        VideoGroupList retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VideoGroupList retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<VideoGroupList> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VideoGroupList> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<VideoGroupList> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VideoGroupList> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<VideoGroupList> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<VideoGroupList>();
        }
        else
        {
            Criteria criteria = new Criteria();
