 ...
 *
 */
public abstract class BaseProtectAdPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(ProtectAdMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(ProtectAdMapBuilder.CLASS_NAME);
    }

    /** the column name for the id field */
    public static final String ID;
    /** the column name for the protect_id field */
    public static final String PROTECT_ID;
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "protect_ad";

        ID = "protect_ad.id";
        PROTECT_ID = "protect_ad.protect_id";
        TYPE = "protect_ad.type";
        VALUE = "protect_ad.value";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(ProtectAdMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(ProtectAdMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ProtectAd> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(PROTECT_ID);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static ProtectAd row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            ProtectAd obj = (ProtectAd) cls.newInstance();
            ProtectAdPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setProtectId(row.getValue(offset + 1).asInt());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ProtectAd> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ProtectAd> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ProtectAd> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<ProtectAd> results = new ArrayList<ProtectAd>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(ProtectAdPeer.row2Object(row, 1,
                ProtectAdPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ProtectAd> doSelect(ProtectAd obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(ProtectAd obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(ProtectAd obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(ProtectAd obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(ProtectAd) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(ProtectAd obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(ProtectAd) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(ProtectAd obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(ProtectAd) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(ProtectAd obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( ProtectAd obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(ID, obj.getId());
        criteria.add(PROTECT_ID, obj.getProtectId());
    ...
    public static Criteria buildSelectCriteria( ProtectAd obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static ProtectAd retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static ProtectAd retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static ProtectAd retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        ProtectAd retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static ProtectAd retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<ProtectAd> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ProtectAd> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<ProtectAd> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ProtectAd> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<ProtectAd> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<ProtectAd>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of ProtectAd objects pre-filled with their
     * Protect objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ProtectAdPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<ProtectAd> doSelectJoinProtect(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinProtect(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<ProtectAd> doSelectJoinProtect(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        ProtectAdPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        ProtectPeer.addSelectColumns(criteria);

        criteria.addJoin(ProtectAdPeer.PROTECT_ID,
            ProtectPeer.ID);
        ...
        List<ProtectAd> results = new ArrayList<ProtectAd>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = ProtectAdPeer.getOMClass();
            ProtectAd obj1 = (ProtectAd) ProtectAdPeer
                .row2Object(row, 1, omClass);
             omClass = ProtectPeer.getOMClass();
            Protect obj2 = (Protect) ProtectPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ProtectAd temp_obj1 =  results.get(j);
                Protect temp_obj2 = (Protect) temp_obj1.getProtect();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addProtectAd(obj1);
                    break;
                }
            }
            if (newObject)
