 ...
 * extended all references should be to CastTag
 */
public abstract class BaseCastTag extends BaseObject
{
    /** The Peer class */
    private static final CastTagPeer peer =
        new CastTagPeer();
    ...
    {
        if (name.equals(CastTagPeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(CastTagPeer.CAST_ID))
        {
            return new Integer(getCastId());
        }
        if (name.equals(CastTagPeer.DIRECT_NAME))
        {
            return getDirectName();
        }
        if (name.equals(CastTagPeer.DIRECT_VALUE))
        {
            return getDirectValue();
        }
        if (name.equals(CastTagPeer.IS_POSITIVE))
        {
            return new Integer(getIsPositive());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (CastTagPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (CastTagPeer.CAST_ID.equals(name))
        {
            return setByName("CastId", value);
        }
      if (CastTagPeer.DIRECT_NAME.equals(name))
        {
            return setByName("DirectName", value);
        }
      if (CastTagPeer.DIRECT_VALUE.equals(name))
        {
            return setByName("DirectValue", value);
        }
      if (CastTagPeer.IS_POSITIVE.equals(name))
        {
    ...
    {
        save(CastTagPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    CastTagPeer.doInsert((CastTag) this, con);
                    setNew(false);
                }
                else
                {
                    CastTagPeer.doUpdate((CastTag) this, con);
                }
            }
     ...
     */
    public CastTag copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public CastTag copy(Connection con) throws TorqueException
    {
     ...
     */
    public CastTag copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new CastTag(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public CastTag copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new CastTag(), deepcopy, con);
    }
     ...
     */
    protected CastTag copyInto(CastTag copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastTag copyInto(CastTag copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected CastTag copyInto(CastTag copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastTag copyInto(CastTag copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setCastId(castId);
        copyObj.setDirectName(directName);
    ...
    {
        return CastTagPeer.getTableMap();
    }

  
    /**
     * Creates a CastTagBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a CastTagBean with the contents of this object
     */
    public CastTagBean getBean()
    {
     ...
     * @return a CastTagBean with the contents of this object
     */
    public CastTagBean getBean(IdentityMap createdBeans)
    {
        CastTagBean result = (CastTagBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new CastTagBean();
    ...
    /**
     * Creates an instance of CastTag with the contents
     * of a CastTagBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the CastTagBean which contents are used to create
     *        the resulting class
     * @return an instance of CastTag with the contents of bean
     */
    public static CastTag createCastTag(CastTagBean bean)
        throws TorqueException
    {
        return createCastTag(bean, new IdentityMap());
    }
    ...
    public static CastTag createCastTag(CastTagBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        CastTag result = (CastTag) createdObjects.get(bean);
        if (result != null)
        {
