 ...
 *
 */
public abstract class BaseVhPositionMapPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(VhPositionMapMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(VhPositionMapMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the v_position_id field */
    public static final String V_POSITION_ID;

    static
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "vh_position_map";

        ID = "vh_position_map.id";
        BLOCK_ID = "vh_position_map.block_id";
        V_POSITION_ID = "vh_position_map.v_position_id";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(VhPositionMapMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(VhPositionMapMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.atm.om.VhPositionMap";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhPositionMap> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(BLOCK_ID);
        criteria.addSelectColumn(V_POSITION_ID);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static VhPositionMap row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            VhPositionMap obj = (VhPositionMap) cls.newInstance();
            VhPositionMapPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setBlockId(row.getValue(offset + 1).asInt());
            obj.setVPositionId(row.getValue(offset + 2).asInt());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhPositionMap> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhPositionMap> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhPositionMap> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<VhPositionMap> results = new ArrayList<VhPositionMap>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(VhPositionMapPeer.row2Object(row, 1,
                VhPositionMapPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhPositionMap> doSelect(VhPositionMap obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(VhPositionMap obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(VhPositionMap obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(VhPositionMap obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(VhPositionMap) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(VhPositionMap obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(VhPositionMap) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(VhPositionMap obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(VhPositionMap) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(VhPositionMap obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( VhPositionMap obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        criteria.add(ID, obj.getId());
        criteria.add(BLOCK_ID, obj.getBlockId());
        criteria.add(V_POSITION_ID, obj.getVPositionId());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( VhPositionMap obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ID, obj.getId());
            criteria.add(BLOCK_ID, obj.getBlockId());
     ...
     */
    public static VhPositionMap retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VhPositionMap retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VhPositionMap retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        VhPositionMap retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VhPositionMap retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<VhPositionMap> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhPositionMap> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<VhPositionMap> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhPositionMap> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<VhPositionMap> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<VhPositionMap>();
        }
        else
        {
            Criteria criteria = new Criteria();
