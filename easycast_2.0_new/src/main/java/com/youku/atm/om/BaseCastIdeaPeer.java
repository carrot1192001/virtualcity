 ...
 *
 */
public abstract class BaseCastIdeaPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(CastIdeaMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(CastIdeaMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the monitor_add_type field */
    public static final String MONITOR_ADD_TYPE;
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "cast_idea";

        ID = "cast_idea.id";
        CAST_ID = "cast_idea.cast_id";
        IDEA_ID = "cast_idea.idea_id";
        UPDATE_TIME = "cast_idea.update_time";
        STATUS = "cast_idea.status";
        ISSDK = "cast_idea.issdk";
        IESORG = "cast_idea.iesorg";
        CUF = "cast_idea.cuf";
        MST = "cast_idea.mst";
        MONITOR_ADD_TYPE = "cast_idea.monitor_add_type";
        WEIGHT = "cast_idea.weight";
        IS_DEFAULT = "cast_idea.is_default";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(CastIdeaMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(CastIdeaMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastIdea> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(MONITOR_ADD_TYPE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static CastIdea row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            CastIdea obj = (CastIdea) cls.newInstance();
            CastIdeaPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setIssdk(row.getValue(offset + 5).asInt());
            obj.setIesorg(row.getValue(offset + 6).asString());
            obj.setCuf(row.getValue(offset + 7).asInt());
            obj.setMst(row.getValue(offset + 8).asInt());
            obj.setMonitorAddType(row.getValue(offset + 9).asInt());
            obj.setWeight(row.getValue(offset + 10).asInt());
            obj.setIsDefault(row.getValue(offset + 11).asInt());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastIdea> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastIdea> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastIdea> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<CastIdea> results = new ArrayList<CastIdea>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(CastIdeaPeer.row2Object(row, 1,
                CastIdeaPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastIdea> doSelect(CastIdea obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastIdea obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastIdea obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastIdea obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(CastIdea) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastIdea obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(CastIdea) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastIdea obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(CastIdea) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastIdea obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( CastIdea obj )
    {
        ...
        criteria.add(MONITOR_ADD_TYPE, obj.getMonitorAddType());
    ...
    public static Criteria buildSelectCriteria( CastIdea obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ID, obj.getId());
            criteria.add(CAST_ID, obj.getCastId());
     ...
     */
    public static CastIdea retrieveByPK(long pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastIdea retrieveByPK(long pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastIdea retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        CastIdea retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastIdea retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<CastIdea> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastIdea> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<CastIdea> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastIdea> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<CastIdea> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<CastIdea>();
        }
        else
        {
            Criteria criteria = new Criteria();
