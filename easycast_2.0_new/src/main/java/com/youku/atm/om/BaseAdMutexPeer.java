 ...
 *
 */
public abstract class BaseAdMutexPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(AdMutexMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(AdMutexMapBuilder.CLASS_NAME);
    }

    /** the column name for the id field */
    public static final String ID;
    /** the column name for the mutex_id field */
    public static final String MUTEX_ID;
    /** the column name for the subject_type field */
    public static final String SUBJECT_TYPE;
    /** the column name for the subject_value field */
    public static final String SUBJECT_VALUE;
    /** the column name for the object_type field */
    public static final String OBJECT_TYPE;
    /** the column name for the object_value field */
    public static final String OBJECT_VALUE;
    /** the column name for the ad_type field */
    public static final String AD_TYPE;
    /** the column name for the sub_Ad_Type field */
    public static final String SUB_AD_TYPE;
    ...
    static
    {
        ...
        ID = "ad_mutex.id";
        MUTEX_ID = "ad_mutex.mutex_id";
        SUBJECT_TYPE = "ad_mutex.subject_type";
        SUBJECT_VALUE = "ad_mutex.subject_value";
        OBJECT_TYPE = "ad_mutex.object_type";
        OBJECT_VALUE = "ad_mutex.object_value";
        AD_TYPE = "ad_mutex.ad_type";
        SUB_AD_TYPE = "ad_mutex.sub_Ad_Type";
        UPDATE_TIME = "ad_mutex.update_time";
        START_TIME = "ad_mutex.start_time";
        END_TIME = "ad_mutex.end_time";
        STATUS = "ad_mutex.status";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(AdMutexMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(AdMutexMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdMutex> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(MUTEX_ID);
        criteria.addSelectColumn(SUBJECT_TYPE);
        criteria.addSelectColumn(SUBJECT_VALUE);
        criteria.addSelectColumn(OBJECT_TYPE);
        criteria.addSelectColumn(OBJECT_VALUE);
        criteria.addSelectColumn(AD_TYPE);
        criteria.addSelectColumn(SUB_AD_TYPE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static AdMutex row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            AdMutex obj = (AdMutex) cls.newInstance();
            AdMutexPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setMutexId(row.getValue(offset + 1).asInt());
            obj.setSubjectType(row.getValue(offset + 2).asInt());
            obj.setSubjectValue(row.getValue(offset + 3).asString());
            obj.setObjectType(row.getValue(offset + 4).asInt());
            obj.setObjectValue(row.getValue(offset + 5).asString());
            obj.setAdType(row.getValue(offset + 6).asString());
            obj.setSubAdType(row.getValue(offset + 7).asString());
            obj.setUpdateTime(row.getValue(offset + 8).asUtilDate());
            obj.setStartTime(row.getValue(offset + 9).asUtilDate());
            obj.setEndTime(row.getValue(offset + 10).asUtilDate());
            obj.setStatus(row.getValue(offset + 11).asInt());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdMutex> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdMutex> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdMutex> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<AdMutex> results = new ArrayList<AdMutex>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(AdMutexPeer.row2Object(row, 1,
                AdMutexPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdMutex> doSelect(AdMutex obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(AdMutex obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(AdMutex obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(AdMutex obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(AdMutex) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(AdMutex obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(AdMutex) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(AdMutex obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(AdMutex) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(AdMutex obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( AdMutex obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(ID, obj.getId());
        criteria.add(MUTEX_ID, obj.getMutexId());
        criteria.add(SUBJECT_TYPE, obj.getSubjectType());
        criteria.add(SUBJECT_VALUE, obj.getSubjectValue());
        criteria.add(OBJECT_TYPE, obj.getObjectType());
        criteria.add(OBJECT_VALUE, obj.getObjectValue());
        criteria.add(AD_TYPE, obj.getAdType());
        criteria.add(SUB_AD_TYPE, obj.getSubAdType());
    ...
    public static Criteria buildSelectCriteria( AdMutex obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static AdMutex retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static AdMutex retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static AdMutex retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        AdMutex retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static AdMutex retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<AdMutex> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdMutex> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<AdMutex> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdMutex> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<AdMutex> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<AdMutex>();
        }
        else
        {
            Criteria criteria = new Criteria();
