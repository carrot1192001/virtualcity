 ...
 *
 */
public abstract class BaseSeedPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(SeedMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(SeedMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        STATUS = "seed.status";
        SITE = "seed.site";
        SURVEY_URL = "seed.survey_url";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(SeedMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(SeedMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Seed> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Seed row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Seed obj = (Seed) cls.newInstance();
            SeedPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setVid(row.getValue(offset + 1).asString());
            ...
            obj.setSite(row.getValue(offset + 6).asInt());
            obj.setSurveyUrl(row.getValue(offset + 7).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Seed> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Seed> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Seed> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Seed> results = new ArrayList<Seed>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(SeedPeer.row2Object(row, 1,
                SeedPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Seed> doSelect(Seed obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Seed obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Seed obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Seed obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Seed) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Seed obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Seed) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Seed obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Seed) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Seed obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Seed obj )
    {
    ...
    public static Criteria buildSelectCriteria( Seed obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ID, obj.getId());
            criteria.add(VID, obj.getVid());
     ...
     */
    public static Seed retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Seed retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Seed retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        Seed retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Seed retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Seed> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Seed> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<Seed> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Seed> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Seed> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Seed>();
        }
        else
        {
            Criteria criteria = new Criteria();
