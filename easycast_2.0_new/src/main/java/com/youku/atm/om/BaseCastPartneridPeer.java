 ...
 *
 */
public abstract class BaseCastPartneridPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(CastPartneridMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(CastPartneridMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "cast_partnerid";

        ID = "cast_partnerid.id";
        CAST_ID = "cast_partnerid.cast_id";
        DIRECT_NAME = "cast_partnerid.direct_name";
        DIRECT_VALUE = "cast_partnerid.direct_value";
        IS_POSITIVE = "cast_partnerid.is_positive";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(CastPartneridMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(CastPartneridMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.atm.om.CastPartnerid";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastPartnerid> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static CastPartnerid row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            CastPartnerid obj = (CastPartnerid) cls.newInstance();
            CastPartneridPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastPartnerid> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastPartnerid> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastPartnerid> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<CastPartnerid> results = new ArrayList<CastPartnerid>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(CastPartneridPeer.row2Object(row, 1,
                CastPartneridPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastPartnerid> doSelect(CastPartnerid obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastPartnerid obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastPartnerid obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastPartnerid obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(CastPartnerid) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastPartnerid obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(CastPartnerid) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastPartnerid obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(CastPartnerid) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastPartnerid obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( CastPartnerid obj )
    {
    ...
    public static Criteria buildSelectCriteria( CastPartnerid obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static CastPartnerid retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastPartnerid retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastPartnerid retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        CastPartnerid retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastPartnerid retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<CastPartnerid> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastPartnerid> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<CastPartnerid> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastPartnerid> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<CastPartnerid> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<CastPartnerid>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of CastPartnerid objects pre-filled with their
     * AdCast objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CastPartneridPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastPartnerid> doSelectJoinAdCast(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastPartnerid> doSelectJoinAdCast(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        CastPartneridPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        AdCastPeer.addSelectColumns(criteria);

        criteria.addJoin(CastPartneridPeer.CAST_ID,
            AdCastPeer.ID);
        ...
        List<CastPartnerid> results = new ArrayList<CastPartnerid>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = CastPartneridPeer.getOMClass();
            CastPartnerid obj1 = (CastPartnerid) CastPartneridPeer
            ...
            {
                CastPartnerid temp_obj1 =  results.get(j);
                AdCast temp_obj2 = (AdCast) temp_obj1.getAdCast();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addCastPartnerid(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initCastPartnerids();
                obj2.addCastPartnerid(obj1);
            }
            results.add(obj1);
        }
        return results;
