 ...
 *
 */
public abstract class BaseSdkDevicePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(SdkDeviceMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(SdkDeviceMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(SdkDeviceMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(SdkDeviceMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkDevice> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static SdkDevice row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            SdkDevice obj = (SdkDevice) cls.newInstance();
            SdkDevicePeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkDevice> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkDevice> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkDevice> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<SdkDevice> results = new ArrayList<SdkDevice>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(SdkDevicePeer.row2Object(row, 1,
                SdkDevicePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkDevice> doSelect(SdkDevice obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SdkDevice obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SdkDevice obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SdkDevice obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(SdkDevice) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SdkDevice obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(SdkDevice) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SdkDevice obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(SdkDevice) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SdkDevice obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( SdkDevice obj )
    {
    ...
    public static Criteria buildSelectCriteria( SdkDevice obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static SdkDevice retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SdkDevice retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SdkDevice retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        SdkDevice retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SdkDevice retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<SdkDevice> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkDevice> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<SdkDevice> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkDevice> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<SdkDevice> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<SdkDevice>();
        }
        else
        {
            Criteria criteria = new Criteria();
