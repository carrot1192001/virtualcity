 ...
 *
 */
public abstract class BaseIdeaMonitorPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(IdeaMonitorMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(IdeaMonitorMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the mt field */
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "idea_monitor";

        ID = "idea_monitor.id";
        IDEA_ID = "idea_monitor.idea_id";
        TYPE = "idea_monitor.type";
        SITE = "idea_monitor.site";
        BT = "idea_monitor.bt";
        URL = "idea_monitor.url";
        MT = "idea_monitor.mt";
        CONTENT = "idea_monitor.content";
        SEQ = "idea_monitor.seq";
        CAST_ID = "idea_monitor.cast_id";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(IdeaMonitorMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(IdeaMonitorMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaMonitor> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static IdeaMonitor row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            IdeaMonitor obj = (IdeaMonitor) cls.newInstance();
            IdeaMonitorPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setType(row.getValue(offset + 2).asInt());
            obj.setSite(row.getValue(offset + 3).asInt());
            obj.setBt(row.getValue(offset + 4).asInt());
            obj.setUrl(row.getValue(offset + 5).asString());
            obj.setMt(row.getValue(offset + 6).asInt());
            obj.setContent(row.getValue(offset + 7).asString());
            obj.setSeq(row.getValue(offset + 8).asInt());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaMonitor> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaMonitor> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaMonitor> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<IdeaMonitor> results = new ArrayList<IdeaMonitor>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(IdeaMonitorPeer.row2Object(row, 1,
                IdeaMonitorPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaMonitor> doSelect(IdeaMonitor obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(IdeaMonitor obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(IdeaMonitor obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(IdeaMonitor obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(IdeaMonitor) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(IdeaMonitor obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(IdeaMonitor) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(IdeaMonitor obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(IdeaMonitor) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(IdeaMonitor obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( IdeaMonitor obj )
    {
    ...
    public static Criteria buildSelectCriteria( IdeaMonitor obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static IdeaMonitor retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaMonitor retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaMonitor retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        IdeaMonitor retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaMonitor retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<IdeaMonitor> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaMonitor> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<IdeaMonitor> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaMonitor> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<IdeaMonitor> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<IdeaMonitor>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of IdeaMonitor objects pre-filled with their
     * Idea objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in IdeaMonitorPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<IdeaMonitor> doSelectJoinIdea(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<IdeaMonitor> doSelectJoinIdea(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        IdeaMonitorPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        IdeaPeer.addSelectColumns(criteria);

        criteria.addJoin(IdeaMonitorPeer.IDEA_ID,
            IdeaPeer.ID);
        ...
        List<IdeaMonitor> results = new ArrayList<IdeaMonitor>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = IdeaMonitorPeer.getOMClass();
            IdeaMonitor obj1 = (IdeaMonitor) IdeaMonitorPeer
            ...
            {
                IdeaMonitor temp_obj1 =  results.get(j);
                Idea temp_obj2 = (Idea) temp_obj1.getIdea();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addIdeaMonitor(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initIdeaMonitors();
                obj2.addIdeaMonitor(obj1);
            }
            results.add(obj1);
        }
        return results;
