 ...
 *
 */
public abstract class BaseIdeaDirectionPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(IdeaDirectionMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(IdeaDirectionMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the direction_type field */
    public static final String DIRECTION_TYPE;
    /** the column name for the direction_value field */
    public static final String DIRECTION_VALUE;

    static
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "idea_direction";

        ID = "idea_direction.id";
        CAST_ID = "idea_direction.cast_id";
        IDEA_ID = "idea_direction.idea_id";
        DIRECTION_TYPE = "idea_direction.direction_type";
        DIRECTION_VALUE = "idea_direction.direction_value";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(IdeaDirectionMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(IdeaDirectionMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.atm.om.IdeaDirection";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaDirection> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(DIRECTION_TYPE);
        criteria.addSelectColumn(DIRECTION_VALUE);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static IdeaDirection row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            IdeaDirection obj = (IdeaDirection) cls.newInstance();
            IdeaDirectionPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setIdeaId(row.getValue(offset + 2).asInt());
            obj.setDirectionType(row.getValue(offset + 3).asString());
            obj.setDirectionValue(row.getValue(offset + 4).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaDirection> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaDirection> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaDirection> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<IdeaDirection> results = new ArrayList<IdeaDirection>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(IdeaDirectionPeer.row2Object(row, 1,
                IdeaDirectionPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaDirection> doSelect(IdeaDirection obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(IdeaDirection obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(IdeaDirection obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(IdeaDirection obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(IdeaDirection) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(IdeaDirection obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(IdeaDirection) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(IdeaDirection obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(IdeaDirection) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(IdeaDirection obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( IdeaDirection obj )
    {
        ...
        criteria.add(DIRECTION_TYPE, obj.getDirectionType());
        criteria.add(DIRECTION_VALUE, obj.getDirectionValue());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( IdeaDirection obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static IdeaDirection retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaDirection retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaDirection retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        IdeaDirection retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaDirection retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<IdeaDirection> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaDirection> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<IdeaDirection> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaDirection> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<IdeaDirection> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<IdeaDirection>();
        }
        else
        {
            Criteria criteria = new Criteria();
