 ...
 *
 */
public abstract class BaseCastConfigPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(CastConfigMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(CastConfigMapBuilder.CLASS_NAME);
    }

    /** the column name for the id field */
    public static final String ID;
    /** the column name for the cast_key field */
    public static final String CAST_KEY;
    /** the column name for the cast_value field */
    public static final String CAST_VALUE;

    static
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "cast_config";

        ID = "cast_config.id";
        CAST_KEY = "cast_config.cast_key";
        CAST_VALUE = "cast_config.cast_value";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(CastConfigMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(CastConfigMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastConfig> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(CAST_KEY);
        criteria.addSelectColumn(CAST_VALUE);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static CastConfig row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            CastConfig obj = (CastConfig) cls.newInstance();
            CastConfigPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setCastKey(row.getValue(offset + 1).asString());
            obj.setCastValue(row.getValue(offset + 2).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastConfig> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastConfig> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastConfig> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<CastConfig> results = new ArrayList<CastConfig>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(CastConfigPeer.row2Object(row, 1,
                CastConfigPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastConfig> doSelect(CastConfig obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastConfig obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastConfig obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastConfig obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(CastConfig) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastConfig obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(CastConfig) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastConfig obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(CastConfig) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastConfig obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( CastConfig obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(ID, obj.getId());
        criteria.add(CAST_KEY, obj.getCastKey());
        criteria.add(CAST_VALUE, obj.getCastValue());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( CastConfig obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static CastConfig retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastConfig retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastConfig retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        CastConfig retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastConfig retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<CastConfig> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastConfig> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<CastConfig> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastConfig> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<CastConfig> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<CastConfig>();
        }
        else
        {
            Criteria criteria = new Criteria();
