 ...
 *
 */
public abstract class BaseLogConfigPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(LogConfigMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(LogConfigMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the remoteport field */
    public static final String REMOTEPORT;
    /** the column name for the localport field */
    public static final String LOCALPORT;
    ...
    /** the column name for the p_type field */
    public static final String P_TYPE;

    static
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "log_config";

        ID = "log_config.id";
        NAME = "log_config.name";
        CODE = "log_config.code";
        IP = "log_config.ip";
        REMOTEPORT = "log_config.remoteport";
        LOCALPORT = "log_config.localport";
        PATH = "log_config.path";
        SITE = "log_config.site";
        LOG_TYPE = "log_config.log_type";
        P_TYPE = "log_config.p_type";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(LogConfigMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(LogConfigMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<LogConfig> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(IP);
        criteria.addSelectColumn(REMOTEPORT);
        criteria.addSelectColumn(LOCALPORT);
        criteria.addSelectColumn(PATH);
        criteria.addSelectColumn(SITE);
        criteria.addSelectColumn(LOG_TYPE);
        criteria.addSelectColumn(P_TYPE);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static LogConfig row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            LogConfig obj = (LogConfig) cls.newInstance();
            LogConfigPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setCode(row.getValue(offset + 2).asString());
            obj.setIp(row.getValue(offset + 3).asString());
            obj.setRemoteport(row.getValue(offset + 4).asString());
            obj.setLocalport(row.getValue(offset + 5).asString());
            obj.setPath(row.getValue(offset + 6).asString());
            obj.setSite(row.getValue(offset + 7).asInt());
            obj.setLogType(row.getValue(offset + 8).asString());
            obj.setPType(row.getValue(offset + 9).asInt());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<LogConfig> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<LogConfig> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<LogConfig> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<LogConfig> results = new ArrayList<LogConfig>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(LogConfigPeer.row2Object(row, 1,
                LogConfigPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<LogConfig> doSelect(LogConfig obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(LogConfig obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(LogConfig obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(LogConfig obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(LogConfig) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(LogConfig obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(LogConfig) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(LogConfig obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(LogConfig) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(LogConfig obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( LogConfig obj )
    {
        ...
        criteria.add(IP, obj.getIp());
        criteria.add(REMOTEPORT, obj.getRemoteport());
        criteria.add(LOCALPORT, obj.getLocalport());
        criteria.add(PATH, obj.getPath());
        criteria.add(SITE, obj.getSite());
        criteria.add(LOG_TYPE, obj.getLogType());
        criteria.add(P_TYPE, obj.getPType());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( LogConfig obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static LogConfig retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static LogConfig retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static LogConfig retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        LogConfig retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static LogConfig retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<LogConfig> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<LogConfig> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<LogConfig> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<LogConfig> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<LogConfig> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<LogConfig>();
        }
        else
        {
            Criteria criteria = new Criteria();
