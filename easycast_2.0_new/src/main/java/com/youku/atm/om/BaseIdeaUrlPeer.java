 ...
 *
 */
public abstract class BaseIdeaUrlPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(IdeaUrlMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(IdeaUrlMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the text1 field */
    public static final String TEXT1;
    /** the column name for the text2 field */
    public static final String TEXT2;
    /** the column name for the idea_width field */
    public static final String IDEA_WIDTH;
    /** the column name for the idea_height field */
    public static final String IDEA_HEIGHT;
    /** the column name for the skip_tx field */
    public static final String SKIP_TX;
    /** the column name for the display_type field */
    public static final String DISPLAY_TYPE;
    /** the column name for the iphonex field */
    public static final String IPHONEX;
    /** the column name for the showtime field */
    public static final String SHOWTIME;
    /** the column name for the seq field */
    public static final String SEQ;
    /** the column name for the bit_rate field */
    public static final String BIT_RATE;
    ...
    static
    {
        ...
        ID = "idea_url.id";
        IDEA_ID = "idea_url.idea_id";
        SITE = "idea_url.site";
        BT = "idea_url.bt";
        TYPE = "idea_url.type";
        OS = "idea_url.os";
        CONTENT = "idea_url.content";
        TITLE = "idea_url.title";
        TEXT1 = "idea_url.text1";
        TEXT2 = "idea_url.text2";
        IDEA_WIDTH = "idea_url.idea_width";
        IDEA_HEIGHT = "idea_url.idea_height";
        SKIP_TX = "idea_url.skip_tx";
        DISPLAY_TYPE = "idea_url.display_type";
        IPHONEX = "idea_url.iphonex";
        SHOWTIME = "idea_url.showtime";
        SEQ = "idea_url.seq";
        BIT_RATE = "idea_url.bit_rate";
        VOLUME = "idea_url.volume";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(IdeaUrlMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(IdeaUrlMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaUrl> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(BT);
        criteria.addSelectColumn(TYPE);
        criteria.addSelectColumn(OS);
        criteria.addSelectColumn(CONTENT);
        criteria.addSelectColumn(TITLE);
        criteria.addSelectColumn(TEXT1);
        criteria.addSelectColumn(TEXT2);
        criteria.addSelectColumn(IDEA_WIDTH);
        criteria.addSelectColumn(IDEA_HEIGHT);
        criteria.addSelectColumn(SKIP_TX);
        criteria.addSelectColumn(DISPLAY_TYPE);
        criteria.addSelectColumn(IPHONEX);
        criteria.addSelectColumn(SHOWTIME);
        criteria.addSelectColumn(SEQ);
        criteria.addSelectColumn(BIT_RATE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static IdeaUrl row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            IdeaUrl obj = (IdeaUrl) cls.newInstance();
            IdeaUrlPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setSite(row.getValue(offset + 2).asInt());
            obj.setBt(row.getValue(offset + 3).asInt());
            obj.setType(row.getValue(offset + 4).asInt());
            obj.setOs(row.getValue(offset + 5).asString());
            obj.setContent(row.getValue(offset + 6).asString());
            obj.setTitle(row.getValue(offset + 7).asString());
            obj.setText1(row.getValue(offset + 8).asString());
            obj.setText2(row.getValue(offset + 9).asString());
            obj.setIdeaWidth(row.getValue(offset + 10).asInt());
            obj.setIdeaHeight(row.getValue(offset + 11).asInt());
            obj.setSkipTx(row.getValue(offset + 12).asString());
            obj.setDisplayType(row.getValue(offset + 13).asInt());
            obj.setIphonex(row.getValue(offset + 14).asInt());
            obj.setShowtime(row.getValue(offset + 15).asInt());
            obj.setSeq(row.getValue(offset + 16).asInt());
            obj.setBitRate(row.getValue(offset + 17).asString());
            obj.setVolume(row.getValue(offset + 18).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaUrl> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaUrl> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaUrl> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<IdeaUrl> results = new ArrayList<IdeaUrl>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(IdeaUrlPeer.row2Object(row, 1,
                IdeaUrlPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaUrl> doSelect(IdeaUrl obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(IdeaUrl obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(IdeaUrl obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(IdeaUrl obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(IdeaUrl) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(IdeaUrl obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(IdeaUrl) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(IdeaUrl obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(IdeaUrl) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(IdeaUrl obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( IdeaUrl obj )
    {
        ...
        criteria.add(BT, obj.getBt());
        criteria.add(TYPE, obj.getType());
        criteria.add(OS, obj.getOs());
        criteria.add(CONTENT, obj.getContent());
        criteria.add(TITLE, obj.getTitle());
        criteria.add(TEXT1, obj.getText1());
        criteria.add(TEXT2, obj.getText2());
        criteria.add(IDEA_WIDTH, obj.getIdeaWidth());
        criteria.add(IDEA_HEIGHT, obj.getIdeaHeight());
        criteria.add(SKIP_TX, obj.getSkipTx());
        criteria.add(DISPLAY_TYPE, obj.getDisplayType());
        criteria.add(IPHONEX, obj.getIphonex());
        criteria.add(SHOWTIME, obj.getShowtime());
        criteria.add(SEQ, obj.getSeq());
        criteria.add(BIT_RATE, obj.getBitRate());
        criteria.add(VOLUME, obj.getVolume());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( IdeaUrl obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static IdeaUrl retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaUrl retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaUrl retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        IdeaUrl retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaUrl retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<IdeaUrl> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaUrl> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<IdeaUrl> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaUrl> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<IdeaUrl> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<IdeaUrl>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of IdeaUrl objects pre-filled with their
     * Idea objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in IdeaUrlPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<IdeaUrl> doSelectJoinIdea(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<IdeaUrl> doSelectJoinIdea(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        IdeaUrlPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        IdeaPeer.addSelectColumns(criteria);

        criteria.addJoin(IdeaUrlPeer.IDEA_ID,
            IdeaPeer.ID);
        ...
        List<IdeaUrl> results = new ArrayList<IdeaUrl>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = IdeaUrlPeer.getOMClass();
            IdeaUrl obj1 = (IdeaUrl) IdeaUrlPeer
            ...
            {
                IdeaUrl temp_obj1 =  results.get(j);
                Idea temp_obj2 = (Idea) temp_obj1.getIdea();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addIdeaUrl(obj1);
                    break;
                }
            }
            if (newObject)
