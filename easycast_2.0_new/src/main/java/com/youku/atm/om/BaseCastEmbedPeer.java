 ...
 *
 */
public abstract class BaseCastEmbedPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(CastEmbedMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(CastEmbedMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the video_id_yk field */
    public static final String VIDEO_ID_YK;
    /** the column name for the video_id_td field */
    public static final String VIDEO_ID_TD;
    /** the column name for the break_id field */
    public static final String BREAK_ID;
    /** the column name for the start_time field */
    public static final String START_TIME;
    /** the column name for the show_time field */
    public static final String SHOW_TIME;

    static
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "cast_embed";

        ID = "cast_embed.id";
        CAST_ID = "cast_embed.cast_id";
        VIDEO_ID_YK = "cast_embed.video_id_yk";
        VIDEO_ID_TD = "cast_embed.video_id_td";
        BREAK_ID = "cast_embed.break_id";
        START_TIME = "cast_embed.start_time";
        SHOW_TIME = "cast_embed.show_time";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(CastEmbedMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(CastEmbedMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastEmbed> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(VIDEO_ID_YK);
        criteria.addSelectColumn(VIDEO_ID_TD);
        criteria.addSelectColumn(BREAK_ID);
        criteria.addSelectColumn(START_TIME);
        criteria.addSelectColumn(SHOW_TIME);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static CastEmbed row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            CastEmbed obj = (CastEmbed) cls.newInstance();
            CastEmbedPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setVideoIdYk(row.getValue(offset + 2).asString());
            obj.setVideoIdTd(row.getValue(offset + 3).asString());
            obj.setBreakId(row.getValue(offset + 4).asString());
            obj.setStartTime(row.getValue(offset + 5).asInt());
            obj.setShowTime(row.getValue(offset + 6).asInt());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastEmbed> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastEmbed> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastEmbed> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<CastEmbed> results = new ArrayList<CastEmbed>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(CastEmbedPeer.row2Object(row, 1,
                CastEmbedPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastEmbed> doSelect(CastEmbed obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastEmbed obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastEmbed obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastEmbed obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(CastEmbed) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastEmbed obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(CastEmbed) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastEmbed obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(CastEmbed) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastEmbed obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( CastEmbed obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(ID, obj.getId());
        criteria.add(CAST_ID, obj.getCastId());
        criteria.add(VIDEO_ID_YK, obj.getVideoIdYk());
        criteria.add(VIDEO_ID_TD, obj.getVideoIdTd());
        criteria.add(BREAK_ID, obj.getBreakId());
        criteria.add(START_TIME, obj.getStartTime());
        criteria.add(SHOW_TIME, obj.getShowTime());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( CastEmbed obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static CastEmbed retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastEmbed retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastEmbed retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        CastEmbed retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastEmbed retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<CastEmbed> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastEmbed> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<CastEmbed> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastEmbed> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<CastEmbed> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<CastEmbed>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of CastEmbed objects pre-filled with their
     * AdCast objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CastEmbedPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastEmbed> doSelectJoinAdCast(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastEmbed> doSelectJoinAdCast(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        CastEmbedPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        AdCastPeer.addSelectColumns(criteria);

        criteria.addJoin(CastEmbedPeer.CAST_ID,
            AdCastPeer.ID);
        ...
        List<CastEmbed> results = new ArrayList<CastEmbed>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = CastEmbedPeer.getOMClass();
            CastEmbed obj1 = (CastEmbed) CastEmbedPeer
            ...
            {
                CastEmbed temp_obj1 =  results.get(j);
                AdCast temp_obj2 = (AdCast) temp_obj1.getAdCast();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addCastEmbed(obj1);
                    break;
                }
            }
            if (newObject)
