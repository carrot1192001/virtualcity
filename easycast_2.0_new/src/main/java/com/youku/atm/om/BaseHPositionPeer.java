 ...
 *
 */
public abstract class BaseHPositionPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(HPositionMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(HPositionMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the templet field */
    public static final String TEMPLET;
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "h_position";

        ID = "h_position.id";
        PARENT_ID = "h_position.parent_id";
        NAME = "h_position.name";
        TYPE = "h_position.type";
        VALUE = "h_position.value";
        TEMPLET = "h_position.templet";
        STATUS = "h_position.status";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(HPositionMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(HPositionMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HPosition> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(TEMPLET);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static HPosition row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            HPosition obj = (HPosition) cls.newInstance();
            HPositionPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setValue(row.getValue(offset + 4).asInt());
            obj.setTemplet(row.getValue(offset + 5).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HPosition> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HPosition> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HPosition> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<HPosition> results = new ArrayList<HPosition>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(HPositionPeer.row2Object(row, 1,
                HPositionPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HPosition> doSelect(HPosition obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(HPosition obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(HPosition obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(HPosition obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(HPosition) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(HPosition obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(HPosition) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(HPosition obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(HPosition) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(HPosition obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( HPosition obj )
    {
        ...
        criteria.add(TEMPLET, obj.getTemplet());
        criteria.add(STATUS, obj.getStatus());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( HPosition obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ID, obj.getId());
            criteria.add(PARENT_ID, obj.getParentId());
     ...
     */
    public static HPosition retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static HPosition retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static HPosition retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        HPosition retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static HPosition retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<HPosition> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HPosition> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<HPosition> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HPosition> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<HPosition> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<HPosition>();
        }
        else
        {
            Criteria criteria = new Criteria();
