 ...
 *
 */
public abstract class BaseCastPlatformPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(CastPlatformMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(CastPlatformMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "cast_platform";

        ID = "cast_platform.id";
        CAST_ID = "cast_platform.cast_id";
        DIRECT_NAME = "cast_platform.direct_name";
        DIRECT_VALUE = "cast_platform.direct_value";
        IS_POSITIVE = "cast_platform.is_positive";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(CastPlatformMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(CastPlatformMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastPlatform> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static CastPlatform row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            CastPlatform obj = (CastPlatform) cls.newInstance();
            CastPlatformPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setDirectValue(row.getValue(offset + 3).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastPlatform> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastPlatform> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastPlatform> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<CastPlatform> results = new ArrayList<CastPlatform>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(CastPlatformPeer.row2Object(row, 1,
                CastPlatformPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastPlatform> doSelect(CastPlatform obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastPlatform obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastPlatform obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastPlatform obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(CastPlatform) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastPlatform obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(CastPlatform) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastPlatform obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(CastPlatform) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastPlatform obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( CastPlatform obj )
    {
    ...
    public static Criteria buildSelectCriteria( CastPlatform obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static CastPlatform retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastPlatform retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastPlatform retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        CastPlatform retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastPlatform retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<CastPlatform> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastPlatform> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<CastPlatform> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastPlatform> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<CastPlatform> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<CastPlatform>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of CastPlatform objects pre-filled with their
     * AdCast objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CastPlatformPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastPlatform> doSelectJoinAdCast(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastPlatform> doSelectJoinAdCast(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        CastPlatformPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        AdCastPeer.addSelectColumns(criteria);

        criteria.addJoin(CastPlatformPeer.CAST_ID,
            AdCastPeer.ID);
        ...
        List<CastPlatform> results = new ArrayList<CastPlatform>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = CastPlatformPeer.getOMClass();
            CastPlatform obj1 = (CastPlatform) CastPlatformPeer
            ...
            {
                CastPlatform temp_obj1 =  results.get(j);
                AdCast temp_obj2 = (AdCast) temp_obj1.getAdCast();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addCastPlatform(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initCastPlatforms();
                obj2.addCastPlatform(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastPlatform> doSelectJoinPlatform(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinPlatform(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastPlatform> doSelectJoinPlatform(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(CastPlatformPeer.DIRECT_VALUE,
            PlatformPeer.VALUE);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            Platform obj2 = (Platform) PlatformPeer
                .row2Object(row, offset, omClass);
            ...
            {
                CastPlatform temp_obj1 =  results.get(j);
                Platform temp_obj2 = (Platform) temp_obj1.getPlatform();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addCastPlatform(obj1);
