 ...
 *
 */
public abstract class BaseCopyrightUserPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(CopyrightUserMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(CopyrightUserMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "copyright_user";

        ID = "copyright_user.id";
        UID = "copyright_user.uid";
        UNAME = "copyright_user.uname";
        STATUS = "copyright_user.status";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(CopyrightUserMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(CopyrightUserMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.atm.om.CopyrightUser";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CopyrightUser> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(UNAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static CopyrightUser row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            CopyrightUser obj = (CopyrightUser) cls.newInstance();
            CopyrightUserPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setUname(row.getValue(offset + 2).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CopyrightUser> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CopyrightUser> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CopyrightUser> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<CopyrightUser> results = new ArrayList<CopyrightUser>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(CopyrightUserPeer.row2Object(row, 1,
                CopyrightUserPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CopyrightUser> doSelect(CopyrightUser obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CopyrightUser obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CopyrightUser obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CopyrightUser obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(CopyrightUser) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CopyrightUser obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(CopyrightUser) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CopyrightUser obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(CopyrightUser) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CopyrightUser obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( CopyrightUser obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(ID, obj.getId());
        criteria.add(UID, obj.getUid());
        criteria.add(UNAME, obj.getUname());
        criteria.add(STATUS, obj.getStatus());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( CopyrightUser obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static CopyrightUser retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CopyrightUser retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CopyrightUser retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        CopyrightUser retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CopyrightUser retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<CopyrightUser> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CopyrightUser> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<CopyrightUser> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CopyrightUser> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<CopyrightUser> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<CopyrightUser>();
        }
        else
        {
            Criteria criteria = new Criteria();
