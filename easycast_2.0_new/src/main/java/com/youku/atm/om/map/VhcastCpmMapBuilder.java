 ...
 *
  */
public class VhcastCpmMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.youku.atm.om.map.VhcastCpmMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("vhcast_cpm");
        TableMap tMap = dbMap.getTable("vhcast_cpm");
        tMap.setJavaName("VhcastCpm");
        tMap.setOMClass( com.youku.atm.om.VhcastCpm.class );
        tMap.setPeerClass( com.youku.atm.om.VhcastCpmPeer.class );
        tMap.setDescription("");
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("atm");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("vhcast_cpm_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("vhcast_cpm");
        }
