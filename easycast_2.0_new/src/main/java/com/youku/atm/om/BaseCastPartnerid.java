 ...
 * extended all references should be to CastPartnerid
 */
public abstract class BaseCastPartnerid extends BaseObject
{
    /** The Peer class */
    private static final CastPartneridPeer peer =
        new CastPartneridPeer();
    ...
    {
        if (name.equals(CastPartneridPeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(CastPartneridPeer.CAST_ID))
        {
            return new Integer(getCastId());
        }
        if (name.equals(CastPartneridPeer.DIRECT_NAME))
        {
            return getDirectName();
        }
        if (name.equals(CastPartneridPeer.DIRECT_VALUE))
        {
            return getDirectValue();
        }
        if (name.equals(CastPartneridPeer.IS_POSITIVE))
        {
            return new Integer(getIsPositive());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (CastPartneridPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (CastPartneridPeer.CAST_ID.equals(name))
        {
            return setByName("CastId", value);
        }
      if (CastPartneridPeer.DIRECT_NAME.equals(name))
        {
            return setByName("DirectName", value);
        }
      if (CastPartneridPeer.DIRECT_VALUE.equals(name))
        {
            return setByName("DirectValue", value);
        }
      if (CastPartneridPeer.IS_POSITIVE.equals(name))
        {
    ...
    {
        save(CastPartneridPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    CastPartneridPeer.doInsert((CastPartnerid) this, con);
                    setNew(false);
                }
                else
                {
                    CastPartneridPeer.doUpdate((CastPartnerid) this, con);
                }
            }
     ...
     */
    public CastPartnerid copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public CastPartnerid copy(Connection con) throws TorqueException
    {
     ...
     */
    public CastPartnerid copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new CastPartnerid(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public CastPartnerid copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new CastPartnerid(), deepcopy, con);
    }
     ...
     */
    protected CastPartnerid copyInto(CastPartnerid copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastPartnerid copyInto(CastPartnerid copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected CastPartnerid copyInto(CastPartnerid copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastPartnerid copyInto(CastPartnerid copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setCastId(castId);
        copyObj.setDirectName(directName);
     ...
     */
    public CastPartneridPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return CastPartneridPeer.getTableMap();
    }

  
    /**
     * Creates a CastPartneridBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a CastPartneridBean with the contents of this object
     */
    public CastPartneridBean getBean()
    {
     ...
     * @return a CastPartneridBean with the contents of this object
     */
    public CastPartneridBean getBean(IdentityMap createdBeans)
    {
        CastPartneridBean result = (CastPartneridBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new CastPartneridBean();
    ...
    /**
     * Creates an instance of CastPartnerid with the contents
     * of a CastPartneridBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the CastPartneridBean which contents are used to create
     *        the resulting class
     * @return an instance of CastPartnerid with the contents of bean
     */
    public static CastPartnerid createCastPartnerid(CastPartneridBean bean)
        throws TorqueException
    {
        return createCastPartnerid(bean, new IdentityMap());
    }
    ...
    public static CastPartnerid createCastPartnerid(CastPartneridBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        CastPartnerid result = (CastPartnerid) createdObjects.get(bean);
        if (result != null)
        {
            // we already have an object for the bean, return it
            return result;
        }
        result = new CastPartnerid();
