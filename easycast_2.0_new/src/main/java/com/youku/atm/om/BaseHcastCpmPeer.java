 ...
 *
 */
public abstract class BaseHcastCpmPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(HcastCpmMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(HcastCpmMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "hcast_cpm";

        ID = "hcast_cpm.id";
        CAST_ID = "hcast_cpm.cast_id";
        CPM = "hcast_cpm.cpm";
        CPC = "hcast_cpm.cpc";
        LUN = "hcast_cpm.lun";
        PERCENT = "hcast_cpm.percent";
        TARGET_DATE = "hcast_cpm.target_date";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(HcastCpmMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(HcastCpmMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HcastCpm> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static HcastCpm row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            HcastCpm obj = (HcastCpm) cls.newInstance();
            HcastCpmPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HcastCpm> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HcastCpm> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HcastCpm> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<HcastCpm> results = new ArrayList<HcastCpm>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(HcastCpmPeer.row2Object(row, 1,
                HcastCpmPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HcastCpm> doSelect(HcastCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(HcastCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(HcastCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(HcastCpm obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(HcastCpm) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(HcastCpm obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(HcastCpm) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(HcastCpm obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(HcastCpm) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(HcastCpm obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( HcastCpm obj )
    {
    ...
    public static Criteria buildSelectCriteria( HcastCpm obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static HcastCpm retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static HcastCpm retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static HcastCpm retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        HcastCpm retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static HcastCpm retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<HcastCpm> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HcastCpm> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<HcastCpm> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HcastCpm> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<HcastCpm> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<HcastCpm>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of HcastCpm objects pre-filled with their
     * AdCast objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in HcastCpmPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<HcastCpm> doSelectJoinAdCast(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<HcastCpm> doSelectJoinAdCast(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        HcastCpmPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        AdCastPeer.addSelectColumns(criteria);

        criteria.addJoin(HcastCpmPeer.CAST_ID,
            AdCastPeer.ID);
        ...
        List<HcastCpm> results = new ArrayList<HcastCpm>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = HcastCpmPeer.getOMClass();
            HcastCpm obj1 = (HcastCpm) HcastCpmPeer
            ...
            {
                HcastCpm temp_obj1 =  results.get(j);
                AdCast temp_obj2 = (AdCast) temp_obj1.getAdCast();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addHcastCpm(obj1);
                    break;
                }
            }
            if (newObject)
