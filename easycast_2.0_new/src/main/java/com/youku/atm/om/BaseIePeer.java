 ...
 *
 */
public abstract class BaseIePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(IeMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(IeMapBuilder.CLASS_NAME);
    }

    /** the column name for the id field */
    public static final String ID;
    /** the column name for the new_ie field */
    public static final String NEW_IE;
    /** the column name for the old_ie field */
    public static final String OLD_IE;
    ...
    static
    {
        ...
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(IeMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(IeMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ie> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(NEW_IE);
        criteria.addSelectColumn(OLD_IE);
        criteria.addSelectColumn(DIRECTION);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Ie row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Ie obj = (Ie) cls.newInstance();
            IePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setNewIe(row.getValue(offset + 1).asInt());
            obj.setOldIe(row.getValue(offset + 2).asInt());
            obj.setDirection(row.getValue(offset + 3).asInt());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ie> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ie> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ie> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Ie> results = new ArrayList<Ie>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(IePeer.row2Object(row, 1,
                IePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ie> doSelect(Ie obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Ie obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Ie obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Ie obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Ie) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Ie obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Ie) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Ie obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Ie) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Ie obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Ie obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        criteria.add(ID, obj.getId());
        criteria.add(NEW_IE, obj.getNewIe());
        criteria.add(OLD_IE, obj.getOldIe());
        criteria.add(DIRECTION, obj.getDirection());
        criteria.add(TYPE, obj.getType());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( Ie obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ID, obj.getId());
            criteria.add(NEW_IE, obj.getNewIe());
     ...
     */
    public static Ie retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Ie retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Ie retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        Ie retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Ie retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Ie> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ie> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<Ie> retVal = null;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Ie> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Ie> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Ie>();
        }
        else
        {
            Criteria criteria = new Criteria();
