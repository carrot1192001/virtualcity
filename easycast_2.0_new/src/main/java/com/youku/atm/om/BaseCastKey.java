 ...
 * extended all references should be to CastKey
 */
public abstract class BaseCastKey extends BaseObject
{
    /** The Peer class */
    private static final CastKeyPeer peer =
        new CastKeyPeer();
    ...
    {
        if (name.equals(CastKeyPeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(CastKeyPeer.CAST_ID))
        {
            return new Integer(getCastId());
        }
        if (name.equals(CastKeyPeer.DIRECT_NAME))
        {
            return getDirectName();
        }
        if (name.equals(CastKeyPeer.DIRECT_VALUE))
        {
            return getDirectValue();
        }
        if (name.equals(CastKeyPeer.IS_POSITIVE))
        {
            return new Integer(getIsPositive());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (CastKeyPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (CastKeyPeer.CAST_ID.equals(name))
        {
            return setByName("CastId", value);
        }
      if (CastKeyPeer.DIRECT_NAME.equals(name))
        {
            return setByName("DirectName", value);
        }
      if (CastKeyPeer.DIRECT_VALUE.equals(name))
        {
            return setByName("DirectValue", value);
        }
      if (CastKeyPeer.IS_POSITIVE.equals(name))
        {
    ...
    {
        save(CastKeyPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    CastKeyPeer.doInsert((CastKey) this, con);
                    setNew(false);
                }
                else
                {
                    CastKeyPeer.doUpdate((CastKey) this, con);
                }
            }
     ...
     */
    public CastKey copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public CastKey copy(Connection con) throws TorqueException
    {
     ...
     */
    public CastKey copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new CastKey(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public CastKey copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new CastKey(), deepcopy, con);
    }
     ...
     */
    protected CastKey copyInto(CastKey copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastKey copyInto(CastKey copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected CastKey copyInto(CastKey copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastKey copyInto(CastKey copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setCastId(castId);
        copyObj.setDirectName(directName);
    ...
    {
        return CastKeyPeer.getTableMap();
    }

  
    /**
     * Creates a CastKeyBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a CastKeyBean with the contents of this object
     */
    public CastKeyBean getBean()
    {
     ...
     * @return a CastKeyBean with the contents of this object
     */
    public CastKeyBean getBean(IdentityMap createdBeans)
    {
        CastKeyBean result = (CastKeyBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new CastKeyBean();
    ...
    /**
     * Creates an instance of CastKey with the contents
     * of a CastKeyBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the CastKeyBean which contents are used to create
     *        the resulting class
     * @return an instance of CastKey with the contents of bean
     */
    public static CastKey createCastKey(CastKeyBean bean)
        throws TorqueException
    {
        return createCastKey(bean, new IdentityMap());
    }
    ...
    public static CastKey createCastKey(CastKeyBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        CastKey result = (CastKey) createdObjects.get(bean);
        if (result != null)
        {
