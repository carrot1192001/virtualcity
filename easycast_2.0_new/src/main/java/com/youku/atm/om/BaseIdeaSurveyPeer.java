 ...
 *
 */
public abstract class BaseIdeaSurveyPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(IdeaSurveyMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(IdeaSurveyMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the stype field */
    public static final String STYPE;
    /** the column name for the site field */
    public static final String SITE;
    /** the column name for the aw field */
    public static final String AW;
    /** the column name for the survey_url field */
    public static final String SURVEY_URL;
    /** the column name for the click_url field */
    public static final String CLICK_URL;
    /** the column name for the survey_text field */
    public static final String SURVEY_TEXT;
    /** the column name for the time_len field */
    public static final String TIME_LEN;

    static
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "idea_survey";

        ID = "idea_survey.id";
        IDEA_ID = "idea_survey.idea_id";
        STYPE = "idea_survey.stype";
        SITE = "idea_survey.site";
        AW = "idea_survey.aw";
        SURVEY_URL = "idea_survey.survey_url";
        CLICK_URL = "idea_survey.click_url";
        SURVEY_TEXT = "idea_survey.survey_text";
        TIME_LEN = "idea_survey.time_len";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(IdeaSurveyMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(IdeaSurveyMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaSurvey> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(STYPE);
        criteria.addSelectColumn(SITE);
        criteria.addSelectColumn(AW);
        criteria.addSelectColumn(SURVEY_URL);
        criteria.addSelectColumn(CLICK_URL);
        criteria.addSelectColumn(SURVEY_TEXT);
        criteria.addSelectColumn(TIME_LEN);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static IdeaSurvey row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            IdeaSurvey obj = (IdeaSurvey) cls.newInstance();
            IdeaSurveyPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setStype(row.getValue(offset + 2).asInt());
            obj.setSite(row.getValue(offset + 3).asInt());
            obj.setAw(row.getValue(offset + 4).asString());
            obj.setSurveyUrl(row.getValue(offset + 5).asString());
            obj.setClickUrl(row.getValue(offset + 6).asString());
            obj.setSurveyText(row.getValue(offset + 7).asString());
            obj.setTimeLen(row.getValue(offset + 8).asInt());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaSurvey> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaSurvey> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaSurvey> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<IdeaSurvey> results = new ArrayList<IdeaSurvey>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(IdeaSurveyPeer.row2Object(row, 1,
                IdeaSurveyPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaSurvey> doSelect(IdeaSurvey obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(IdeaSurvey obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(IdeaSurvey obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(IdeaSurvey obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(IdeaSurvey) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(IdeaSurvey obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(IdeaSurvey) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(IdeaSurvey obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(IdeaSurvey) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(IdeaSurvey obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( IdeaSurvey obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(ID, obj.getId());
        criteria.add(IDEA_ID, obj.getIdeaId());
        criteria.add(STYPE, obj.getStype());
        criteria.add(SITE, obj.getSite());
        criteria.add(AW, obj.getAw());
        criteria.add(SURVEY_URL, obj.getSurveyUrl());
        criteria.add(CLICK_URL, obj.getClickUrl());
        criteria.add(SURVEY_TEXT, obj.getSurveyText());
        criteria.add(TIME_LEN, obj.getTimeLen());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( IdeaSurvey obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static IdeaSurvey retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaSurvey retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaSurvey retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        IdeaSurvey retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaSurvey retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<IdeaSurvey> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaSurvey> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<IdeaSurvey> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaSurvey> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<IdeaSurvey> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<IdeaSurvey>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of IdeaSurvey objects pre-filled with their
     * Idea objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in IdeaSurveyPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<IdeaSurvey> doSelectJoinIdea(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<IdeaSurvey> doSelectJoinIdea(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        IdeaSurveyPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        IdeaPeer.addSelectColumns(criteria);

        criteria.addJoin(IdeaSurveyPeer.IDEA_ID,
            IdeaPeer.ID);
        ...
        List<IdeaSurvey> results = new ArrayList<IdeaSurvey>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = IdeaSurveyPeer.getOMClass();
            IdeaSurvey obj1 = (IdeaSurvey) IdeaSurveyPeer
            ...
            {
                IdeaSurvey temp_obj1 =  results.get(j);
                Idea temp_obj2 = (Idea) temp_obj1.getIdea();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addIdeaSurvey(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initIdeaSurveys();
                obj2.addIdeaSurvey(obj1);
            }
            results.add(obj1);
        }
        return results;
