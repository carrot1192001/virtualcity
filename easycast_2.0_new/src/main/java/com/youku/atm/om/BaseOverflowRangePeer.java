 ...
 *
 */
public abstract class BaseOverflowRangePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(OverflowRangeMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(OverflowRangeMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "overflow_range";

        ID = "overflow_range.id";
        RESOURCE_ID = "overflow_range.resource_id";
        CONTENTS = "overflow_range.contents";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(OverflowRangeMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(OverflowRangeMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.atm.om.OverflowRange";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<OverflowRange> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(CONTENTS);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static OverflowRange row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            OverflowRange obj = (OverflowRange) cls.newInstance();
            OverflowRangePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setContents(row.getValue(offset + 2).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<OverflowRange> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<OverflowRange> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<OverflowRange> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<OverflowRange> results = new ArrayList<OverflowRange>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(OverflowRangePeer.row2Object(row, 1,
                OverflowRangePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<OverflowRange> doSelect(OverflowRange obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(OverflowRange obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(OverflowRange obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(OverflowRange obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(OverflowRange) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(OverflowRange obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(OverflowRange) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(OverflowRange obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(OverflowRange) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(OverflowRange obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( OverflowRange obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        criteria.add(ID, obj.getId());
        criteria.add(RESOURCE_ID, obj.getResourceId());
        criteria.add(CONTENTS, obj.getContents());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( OverflowRange obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ID, obj.getId());
            criteria.add(RESOURCE_ID, obj.getResourceId());
     ...
     */
    public static OverflowRange retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static OverflowRange retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static OverflowRange retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        OverflowRange retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static OverflowRange retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<OverflowRange> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<OverflowRange> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<OverflowRange> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<OverflowRange> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<OverflowRange> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<OverflowRange>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of OverflowRange objects pre-filled with their
     * Resource objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in OverflowRangePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<OverflowRange> doSelectJoinResource(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<OverflowRange> doSelectJoinResource(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        OverflowRangePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        ResourcePeer.addSelectColumns(criteria);

        criteria.addJoin(OverflowRangePeer.RESOURCE_ID,
            ResourcePeer.ID);
        ...
        List<OverflowRange> results = new ArrayList<OverflowRange>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = OverflowRangePeer.getOMClass();
            OverflowRange obj1 = (OverflowRange) OverflowRangePeer
            ...
            {
                OverflowRange temp_obj1 =  results.get(j);
                Resource temp_obj2 = (Resource) temp_obj1.getResource();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addOverflowRange(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initOverflowRanges();
                obj2.addOverflowRange(obj1);
            }
            results.add(obj1);
        }
        return results;
