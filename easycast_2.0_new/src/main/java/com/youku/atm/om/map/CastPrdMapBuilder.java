 ...
 *
  */
public class CastPrdMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.youku.atm.om.map.CastPrdMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("cast_prd");
        TableMap tMap = dbMap.getTable("cast_prd");
        tMap.setJavaName("CastPrd");
        tMap.setOMClass( com.youku.atm.om.CastPrd.class );
        tMap.setPeerClass( com.youku.atm.om.CastPrdPeer.class );
        tMap.setDescription("");
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("atm");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("cast_prd_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("cast_prd");
        }
