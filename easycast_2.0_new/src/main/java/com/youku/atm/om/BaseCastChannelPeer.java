 ...
 *
 */
public abstract class BaseCastChannelPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(CastChannelMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(CastChannelMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "cast_channel";

        ID = "cast_channel.id";
        CAST_ID = "cast_channel.cast_id";
        DIRECT_NAME = "cast_channel.direct_name";
        DIRECT_VALUE = "cast_channel.direct_value";
        IS_POSITIVE = "cast_channel.is_positive";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(CastChannelMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(CastChannelMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastChannel> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static CastChannel row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            CastChannel obj = (CastChannel) cls.newInstance();
            CastChannelPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastChannel> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastChannel> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastChannel> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<CastChannel> results = new ArrayList<CastChannel>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(CastChannelPeer.row2Object(row, 1,
                CastChannelPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastChannel> doSelect(CastChannel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastChannel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastChannel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastChannel obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(CastChannel) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastChannel obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(CastChannel) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastChannel obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(CastChannel) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastChannel obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( CastChannel obj )
    {
    ...
    public static Criteria buildSelectCriteria( CastChannel obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static CastChannel retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastChannel retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastChannel retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        CastChannel retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastChannel retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<CastChannel> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastChannel> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<CastChannel> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastChannel> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<CastChannel> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<CastChannel>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of CastChannel objects pre-filled with their
     * AdCast objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CastChannelPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastChannel> doSelectJoinAdCast(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastChannel> doSelectJoinAdCast(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        CastChannelPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        AdCastPeer.addSelectColumns(criteria);

        criteria.addJoin(CastChannelPeer.CAST_ID,
            AdCastPeer.ID);
        ...
        List<CastChannel> results = new ArrayList<CastChannel>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = CastChannelPeer.getOMClass();
            CastChannel obj1 = (CastChannel) CastChannelPeer
            ...
            {
                CastChannel temp_obj1 =  results.get(j);
                AdCast temp_obj2 = (AdCast) temp_obj1.getAdCast();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addCastChannel(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initCastChannels();
                obj2.addCastChannel(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastChannel> doSelectJoinChannel(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinChannel(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastChannel> doSelectJoinChannel(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(CastChannelPeer.DIRECT_VALUE,
            ChannelPeer.ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            {
                CastChannel temp_obj1 =  results.get(j);
                Channel temp_obj2 = (Channel) temp_obj1.getChannel();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addCastChannel(obj1);
