 ...
 *
 */
public abstract class BaseCampaignPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(CampaignMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(CampaignMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the daylimit field */
    public static final String DAYLIMIT;
    /** the column name for the unite field */
    public static final String UNITE;
    ...
    static
    {
        ...
        NUMLIMIT = "campaign.numlimit";
        DAYLIMIT = "campaign.daylimit";
        UNITE = "campaign.unite";
        STATUS = "campaign.status";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(CampaignMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(CampaignMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Campaign> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(DAYLIMIT);
        criteria.addSelectColumn(UNITE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static Campaign row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            Campaign obj = (Campaign) cls.newInstance();
            CampaignPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setDaylimit(row.getValue(offset + 7).asString());
            obj.setUnite(row.getValue(offset + 8).asInt());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Campaign> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Campaign> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Campaign> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Campaign> results = new ArrayList<Campaign>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(CampaignPeer.row2Object(row, 1,
                CampaignPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Campaign> doSelect(Campaign obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Campaign obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Campaign obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Campaign obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(Campaign) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Campaign obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(Campaign) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Campaign obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(Campaign) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Campaign obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Campaign obj )
    {
        ...
        criteria.add(DAYLIMIT, obj.getDaylimit());
        criteria.add(UNITE, obj.getUnite());
        criteria.add(STATUS, obj.getStatus());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( Campaign obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ID, obj.getId());
            criteria.add(NAME, obj.getName());
     ...
     */
    public static Campaign retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Campaign retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Campaign retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Campaign retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Campaign> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Campaign> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Campaign> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Campaign> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Campaign>();
        }
        else
        {
            Criteria criteria = new Criteria();
