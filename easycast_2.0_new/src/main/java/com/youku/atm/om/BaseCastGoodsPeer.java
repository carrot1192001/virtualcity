 ...
 *
 */
public abstract class BaseCastGoodsPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(CastGoodsMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(CastGoodsMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "cast_goods";

        ID = "cast_goods.id";
        CAST_ID = "cast_goods.cast_id";
        DIRECT_NAME = "cast_goods.direct_name";
        DIRECT_VALUE = "cast_goods.direct_value";
        IS_POSITIVE = "cast_goods.is_positive";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(CastGoodsMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(CastGoodsMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastGoods> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static CastGoods row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            CastGoods obj = (CastGoods) cls.newInstance();
            CastGoodsPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastGoods> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastGoods> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastGoods> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<CastGoods> results = new ArrayList<CastGoods>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(CastGoodsPeer.row2Object(row, 1,
                CastGoodsPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastGoods> doSelect(CastGoods obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastGoods obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastGoods obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastGoods obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(CastGoods) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastGoods obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(CastGoods) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastGoods obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(CastGoods) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastGoods obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( CastGoods obj )
    {
    ...
    public static Criteria buildSelectCriteria( CastGoods obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static CastGoods retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastGoods retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastGoods retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        CastGoods retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastGoods retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<CastGoods> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastGoods> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<CastGoods> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastGoods> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<CastGoods> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<CastGoods>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of CastGoods objects pre-filled with their
     * AdCast objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CastGoodsPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastGoods> doSelectJoinAdCast(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastGoods> doSelectJoinAdCast(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        CastGoodsPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        AdCastPeer.addSelectColumns(criteria);

        criteria.addJoin(CastGoodsPeer.CAST_ID,
            AdCastPeer.ID);
        ...
        List<CastGoods> results = new ArrayList<CastGoods>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = CastGoodsPeer.getOMClass();
            CastGoods obj1 = (CastGoods) CastGoodsPeer
            ...
            {
                CastGoods temp_obj1 =  results.get(j);
                AdCast temp_obj2 = (AdCast) temp_obj1.getAdCast();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addCastGoods(obj1);
                    break;
                }
            }
            if (newObject)
