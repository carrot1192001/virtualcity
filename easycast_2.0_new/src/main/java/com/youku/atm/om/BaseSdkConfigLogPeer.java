 ...
 *
 */
public abstract class BaseSdkConfigLogPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(SdkConfigLogMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(SdkConfigLogMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "sdk_config_log";

        ID = "sdk_config_log.id";
        DEVICE_ID = "sdk_config_log.device_id";
        AD_TYPE_ID = "sdk_config_log.ad_type_id";
        SDK_ID = "sdk_config_log.sdk_id";
        PERCENT = "sdk_config_log.percent";
        CREATE_DATE = "sdk_config_log.create_date";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(SdkConfigLogMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(SdkConfigLogMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkConfigLog> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static SdkConfigLog row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            SdkConfigLog obj = (SdkConfigLog) cls.newInstance();
            SdkConfigLogPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setPercent(row.getValue(offset + 4).asInt());
            obj.setCreateDate(row.getValue(offset + 5).asUtilDate());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkConfigLog> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkConfigLog> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkConfigLog> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<SdkConfigLog> results = new ArrayList<SdkConfigLog>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(SdkConfigLogPeer.row2Object(row, 1,
                SdkConfigLogPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkConfigLog> doSelect(SdkConfigLog obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SdkConfigLog obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SdkConfigLog obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SdkConfigLog obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(SdkConfigLog) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SdkConfigLog obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(SdkConfigLog) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SdkConfigLog obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(SdkConfigLog) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SdkConfigLog obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( SdkConfigLog obj )
    {
    ...
    public static Criteria buildSelectCriteria( SdkConfigLog obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static SdkConfigLog retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SdkConfigLog retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SdkConfigLog retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        SdkConfigLog retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SdkConfigLog retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<SdkConfigLog> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkConfigLog> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<SdkConfigLog> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkConfigLog> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<SdkConfigLog> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<SdkConfigLog>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of SdkConfigLog objects pre-filled with their
     * SdkDevice objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SdkConfigLogPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkConfigLog> doSelectJoinSdkDevice(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkConfigLog> doSelectJoinSdkDevice(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        SdkConfigLogPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        SdkDevicePeer.addSelectColumns(criteria);

        criteria.addJoin(SdkConfigLogPeer.DEVICE_ID,
            SdkDevicePeer.ID);
        ...
        List<SdkConfigLog> results = new ArrayList<SdkConfigLog>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = SdkConfigLogPeer.getOMClass();
            SdkConfigLog obj1 = (SdkConfigLog) SdkConfigLogPeer
            ...
            {
                SdkConfigLog temp_obj1 =  results.get(j);
                SdkDevice temp_obj2 = (SdkDevice) temp_obj1.getSdkDevice();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addSdkConfigLog(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initSdkConfigLogs();
                obj2.addSdkConfigLog(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkConfigLog> doSelectJoinAdType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkConfigLog> doSelectJoinAdType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(SdkConfigLogPeer.AD_TYPE_ID,
            AdTypePeer.ID);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkConfigLog> doSelectJoinSdkName(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkConfigLog> doSelectJoinSdkName(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(SdkConfigLogPeer.SDK_ID,
            SdkNamePeer.ID);
    ...
    /**
     * selects a collection of SdkConfigLog objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkConfigLog> doSelectJoinAllExceptSdkDevice(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkConfigLog> doSelectJoinAllExceptSdkDevice(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        AdTypePeer.addSelectColumns(criteria);
        criteria.addJoin(SdkConfigLogPeer.AD_TYPE_ID, AdTypePeer.ID);
        int offset3 = offset2 + AdTypePeer.numColumns;

        SdkNamePeer.addSelectColumns(criteria);
        criteria.addJoin(SdkConfigLogPeer.SDK_ID, SdkNamePeer.ID);
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj3.addSdkConfigLog(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initSdkConfigLogs();
                obj3.addSdkConfigLog(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkConfigLog> doSelectJoinAllExceptAdType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkConfigLog> doSelectJoinAllExceptAdType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        SdkDevicePeer.addSelectColumns(criteria);
        criteria.addJoin(SdkConfigLogPeer.DEVICE_ID, SdkDevicePeer.ID);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkConfigLog> doSelectJoinAllExceptSdkName(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkConfigLog> doSelectJoinAllExceptSdkName(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
