 ...
 * extended all references should be to CastUser
 */
public abstract class BaseCastUser extends BaseObject
{
    /** The Peer class */
    private static final CastUserPeer peer =
        new CastUserPeer();
    ...
    {
        if (name.equals(CastUserPeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(CastUserPeer.CAST_ID))
        {
            return new Integer(getCastId());
        }
        if (name.equals(CastUserPeer.DIRECT_NAME))
        {
            return getDirectName();
        }
        if (name.equals(CastUserPeer.DIRECT_VALUE))
        {
            return getDirectValue();
        }
        if (name.equals(CastUserPeer.IS_POSITIVE))
        {
            return new Integer(getIsPositive());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (CastUserPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (CastUserPeer.CAST_ID.equals(name))
        {
            return setByName("CastId", value);
        }
      if (CastUserPeer.DIRECT_NAME.equals(name))
        {
            return setByName("DirectName", value);
        }
      if (CastUserPeer.DIRECT_VALUE.equals(name))
        {
            return setByName("DirectValue", value);
        }
      if (CastUserPeer.IS_POSITIVE.equals(name))
        {
    ...
    {
        save(CastUserPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    CastUserPeer.doInsert((CastUser) this, con);
                    setNew(false);
                }
                else
                {
                    CastUserPeer.doUpdate((CastUser) this, con);
                }
            }
     ...
     */
    public CastUser copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public CastUser copy(Connection con) throws TorqueException
    {
     ...
     */
    public CastUser copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new CastUser(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public CastUser copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new CastUser(), deepcopy, con);
    }
     ...
     */
    protected CastUser copyInto(CastUser copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastUser copyInto(CastUser copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected CastUser copyInto(CastUser copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastUser copyInto(CastUser copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setCastId(castId);
        copyObj.setDirectName(directName);
    ...
    {
        return CastUserPeer.getTableMap();
    }

  
    /**
     * Creates a CastUserBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a CastUserBean with the contents of this object
     */
    public CastUserBean getBean()
    {
     ...
     * @return a CastUserBean with the contents of this object
     */
    public CastUserBean getBean(IdentityMap createdBeans)
    {
        CastUserBean result = (CastUserBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new CastUserBean();
    ...
    /**
     * Creates an instance of CastUser with the contents
     * of a CastUserBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the CastUserBean which contents are used to create
     *        the resulting class
     * @return an instance of CastUser with the contents of bean
     */
    public static CastUser createCastUser(CastUserBean bean)
        throws TorqueException
    {
        return createCastUser(bean, new IdentityMap());
    }
    ...
    public static CastUser createCastUser(CastUserBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        CastUser result = (CastUser) createdObjects.get(bean);
        if (result != null)
        {
