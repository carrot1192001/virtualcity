 ...
 *
 */
public abstract class BaseCastAreaPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(CastAreaMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(CastAreaMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "cast_area";

        ID = "cast_area.id";
        CAST_ID = "cast_area.cast_id";
        DIRECT_NAME = "cast_area.direct_name";
        DIRECT_VALUE = "cast_area.direct_value";
        IS_POSITIVE = "cast_area.is_positive";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(CastAreaMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(CastAreaMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastArea> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static CastArea row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            CastArea obj = (CastArea) cls.newInstance();
            CastAreaPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastArea> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastArea> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastArea> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<CastArea> results = new ArrayList<CastArea>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(CastAreaPeer.row2Object(row, 1,
                CastAreaPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastArea> doSelect(CastArea obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastArea obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastArea obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastArea obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(CastArea) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastArea obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(CastArea) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastArea obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(CastArea) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastArea obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( CastArea obj )
    {
    ...
    public static Criteria buildSelectCriteria( CastArea obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static CastArea retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastArea retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastArea retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        CastArea retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastArea retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<CastArea> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastArea> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<CastArea> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastArea> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<CastArea> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<CastArea>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of CastArea objects pre-filled with their
     * AdCast objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CastAreaPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastArea> doSelectJoinAdCast(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastArea> doSelectJoinAdCast(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        CastAreaPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        AdCastPeer.addSelectColumns(criteria);

        criteria.addJoin(CastAreaPeer.CAST_ID,
            AdCastPeer.ID);
        ...
        List<CastArea> results = new ArrayList<CastArea>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = CastAreaPeer.getOMClass();
            CastArea obj1 = (CastArea) CastAreaPeer
            ...
            {
                CastArea temp_obj1 =  results.get(j);
                AdCast temp_obj2 = (AdCast) temp_obj1.getAdCast();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addCastArea(obj1);
                    break;
                }
            }
            if (newObject)
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastArea> doSelectJoinArea(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinArea(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastArea> doSelectJoinArea(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(CastAreaPeer.DIRECT_VALUE,
            AreaPeer.ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            {
                CastArea temp_obj1 =  results.get(j);
                Area temp_obj2 = (Area) temp_obj1.getArea();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addCastArea(obj1);
