 ...
 * extended; all references should be to CastHpositionBean
 */
public abstract class BaseCastHpositionBean
    implements Serializable
{
    ...
    private HPositionBean aHPositionBean;

    /**
     * sets an associated HPositionBean object
     *
     * @param v HPositionBean
     */
    public void setHPositionBean(HPositionBean v)
    {
        if (v == null)
        {
            setDirectValue( 0);
    ...
    /**
     * Get the associated HPositionBean object
     *
     * @return the associated HPositionBean object
     */
    public HPositionBean getHPositionBean()
    {
        return aHPositionBean;
    }
