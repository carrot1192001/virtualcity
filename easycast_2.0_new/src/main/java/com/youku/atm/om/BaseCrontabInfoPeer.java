 ...
 *
 */
public abstract class BaseCrontabInfoPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(CrontabInfoMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(CrontabInfoMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the task_url field */
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "crontab_info";

        ID = "crontab_info.id";
        PERIOD = "crontab_info.period";
        TASK_URL = "crontab_info.task_url";
        IP = "crontab_info.ip";
        STATUS = "crontab_info.status";
        DESCRIPTION = "crontab_info.description";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(CrontabInfoMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(CrontabInfoMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CrontabInfo> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(TASK_URL);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static CrontabInfo row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            CrontabInfo obj = (CrontabInfo) cls.newInstance();
            CrontabInfoPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setPeriod(row.getValue(offset + 1).asString());
            obj.setTaskUrl(row.getValue(offset + 2).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CrontabInfo> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CrontabInfo> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CrontabInfo> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<CrontabInfo> results = new ArrayList<CrontabInfo>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(CrontabInfoPeer.row2Object(row, 1,
                CrontabInfoPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CrontabInfo> doSelect(CrontabInfo obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CrontabInfo obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CrontabInfo obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CrontabInfo obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(CrontabInfo) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CrontabInfo obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(CrontabInfo) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CrontabInfo obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(CrontabInfo) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CrontabInfo obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( CrontabInfo obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(ID, obj.getId());
        criteria.add(PERIOD, obj.getPeriod());
        criteria.add(TASK_URL, obj.getTaskUrl());
    ...
    public static Criteria buildSelectCriteria( CrontabInfo obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static CrontabInfo retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CrontabInfo retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CrontabInfo retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        CrontabInfo retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CrontabInfo retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<CrontabInfo> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CrontabInfo> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<CrontabInfo> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CrontabInfo> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<CrontabInfo> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<CrontabInfo>();
        }
        else
        {
            Criteria criteria = new Criteria();
