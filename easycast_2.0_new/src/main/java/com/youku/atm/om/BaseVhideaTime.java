 ...
 * extended all references should be to VhideaTime
 */
public abstract class BaseVhideaTime extends BaseObject
{
    /** The Peer class */
    private static final VhideaTimePeer peer =
        new VhideaTimePeer();
    ...
    {
        if (name.equals(VhideaTimePeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(VhideaTimePeer.IDEA_ID))
        {
            return new Integer(getIdeaId());
        }
        if (name.equals(VhideaTimePeer.STARTTIME))
        {
            return getStarttime();
        }
        if (name.equals(VhideaTimePeer.ENDTIME))
        {
            return getEndtime();
        }
        if (name.equals(VhideaTimePeer.DC_ID))
        {
            return new Integer(getDcId());
        }
        if (name.equals(VhideaTimePeer.STATUS))
        {
            return new Integer(getStatus());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (VhideaTimePeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (VhideaTimePeer.IDEA_ID.equals(name))
        {
            return setByName("IdeaId", value);
        }
      if (VhideaTimePeer.STARTTIME.equals(name))
        {
            return setByName("Starttime", value);
        }
      if (VhideaTimePeer.ENDTIME.equals(name))
        {
            return setByName("Endtime", value);
        }
      if (VhideaTimePeer.DC_ID.equals(name))
        {
            return setByName("DcId", value);
        }
      if (VhideaTimePeer.STATUS.equals(name))
        {
    ...
    {
        save(VhideaTimePeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    VhideaTimePeer.doInsert((VhideaTime) this, con);
                    setNew(false);
                }
                else
                {
                    VhideaTimePeer.doUpdate((VhideaTime) this, con);
                }
            }
     ...
     */
    public VhideaTime copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public VhideaTime copy(Connection con) throws TorqueException
    {
     ...
     */
    public VhideaTime copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new VhideaTime(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public VhideaTime copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new VhideaTime(), deepcopy, con);
    }
     ...
     */
    protected VhideaTime copyInto(VhideaTime copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected VhideaTime copyInto(VhideaTime copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected VhideaTime copyInto(VhideaTime copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected VhideaTime copyInto(VhideaTime copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setIdeaId(ideaId);
        copyObj.setStarttime(starttime);
    ...
    {
        return VhideaTimePeer.getTableMap();
    }

  
    /**
     * Creates a VhideaTimeBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a VhideaTimeBean with the contents of this object
     */
    public VhideaTimeBean getBean()
    {
     ...
     * @return a VhideaTimeBean with the contents of this object
     */
    public VhideaTimeBean getBean(IdentityMap createdBeans)
    {
        VhideaTimeBean result = (VhideaTimeBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new VhideaTimeBean();
    ...
    /**
     * Creates an instance of VhideaTime with the contents
     * of a VhideaTimeBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the VhideaTimeBean which contents are used to create
     *        the resulting class
     * @return an instance of VhideaTime with the contents of bean
     */
    public static VhideaTime createVhideaTime(VhideaTimeBean bean)
        throws TorqueException
    {
        return createVhideaTime(bean, new IdentityMap());
    }
    ...
    public static VhideaTime createVhideaTime(VhideaTimeBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        VhideaTime result = (VhideaTime) createdObjects.get(bean);
        if (result != null)
        {
            // we already have an object for the bean, return it
            return result;
        }
        result = new VhideaTime();
