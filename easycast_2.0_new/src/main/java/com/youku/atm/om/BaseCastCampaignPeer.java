 ...
 *
 */
public abstract class BaseCastCampaignPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(CastCampaignMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(CastCampaignMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the campaign_num field */
    public static final String CAMPAIGN_NUM;

    static
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "cast_campaign";

        ID = "cast_campaign.id";
        CAST_ID = "cast_campaign.cast_id";
        CAMPAIGN_ID = "cast_campaign.campaign_id";
        CAMPAIGN_NUM = "cast_campaign.campaign_num";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(CastCampaignMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(CastCampaignMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastCampaign> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(CAMPAIGN_ID);
        criteria.addSelectColumn(CAMPAIGN_NUM);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static CastCampaign row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            CastCampaign obj = (CastCampaign) cls.newInstance();
            CastCampaignPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setCampaignId(row.getValue(offset + 2).asInt());
            obj.setCampaignNum(row.getValue(offset + 3).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastCampaign> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastCampaign> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastCampaign> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<CastCampaign> results = new ArrayList<CastCampaign>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(CastCampaignPeer.row2Object(row, 1,
                CastCampaignPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastCampaign> doSelect(CastCampaign obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastCampaign obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastCampaign obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastCampaign obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(CastCampaign) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastCampaign obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(CastCampaign) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastCampaign obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(CastCampaign) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastCampaign obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( CastCampaign obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(ID, obj.getId());
        criteria.add(CAST_ID, obj.getCastId());
        criteria.add(CAMPAIGN_ID, obj.getCampaignId());
        criteria.add(CAMPAIGN_NUM, obj.getCampaignNum());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( CastCampaign obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static CastCampaign retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastCampaign retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastCampaign retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        CastCampaign retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastCampaign retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<CastCampaign> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastCampaign> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<CastCampaign> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastCampaign> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<CastCampaign> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<CastCampaign>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of CastCampaign objects pre-filled with their
     * AdCast objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CastCampaignPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastCampaign> doSelectJoinAdCast(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastCampaign> doSelectJoinAdCast(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        CastCampaignPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        AdCastPeer.addSelectColumns(criteria);

        criteria.addJoin(CastCampaignPeer.CAST_ID,
            AdCastPeer.ID);
        ...
        List<CastCampaign> results = new ArrayList<CastCampaign>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = CastCampaignPeer.getOMClass();
            CastCampaign obj1 = (CastCampaign) CastCampaignPeer
            ...
            {
                CastCampaign temp_obj1 =  results.get(j);
                AdCast temp_obj2 = (AdCast) temp_obj1.getAdCast();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addCastCampaign(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initCastCampaigns();
                obj2.addCastCampaign(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastCampaign> doSelectJoinCampaign(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinCampaign(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastCampaign> doSelectJoinCampaign(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(CastCampaignPeer.CAMPAIGN_ID,
            CampaignPeer.ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            Campaign obj2 = (Campaign) CampaignPeer
                .row2Object(row, offset, omClass);
            ...
            {
                CastCampaign temp_obj1 =  results.get(j);
                Campaign temp_obj2 = (Campaign) temp_obj1.getCampaign();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addCastCampaign(obj1);
