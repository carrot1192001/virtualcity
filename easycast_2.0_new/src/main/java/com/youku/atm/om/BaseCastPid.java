 ...
 * extended all references should be to CastPid
 */
public abstract class BaseCastPid extends BaseObject
{
    /** The Peer class */
    private static final CastPidPeer peer =
        new CastPidPeer();
    ...
    {
        if (name.equals(CastPidPeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(CastPidPeer.CAST_ID))
        {
            return new Integer(getCastId());
        }
        if (name.equals(CastPidPeer.DIRECT_NAME))
        {
            return getDirectName();
        }
        if (name.equals(CastPidPeer.DIRECT_VALUE))
        {
            return getDirectValue();
        }
        if (name.equals(CastPidPeer.IS_POSITIVE))
        {
            return new Integer(getIsPositive());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (CastPidPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (CastPidPeer.CAST_ID.equals(name))
        {
            return setByName("CastId", value);
        }
      if (CastPidPeer.DIRECT_NAME.equals(name))
        {
            return setByName("DirectName", value);
        }
      if (CastPidPeer.DIRECT_VALUE.equals(name))
        {
            return setByName("DirectValue", value);
        }
      if (CastPidPeer.IS_POSITIVE.equals(name))
        {
    ...
    {
        save(CastPidPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    CastPidPeer.doInsert((CastPid) this, con);
                    setNew(false);
                }
                else
                {
                    CastPidPeer.doUpdate((CastPid) this, con);
                }
            }
     ...
     */
    public CastPid copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public CastPid copy(Connection con) throws TorqueException
    {
     ...
     */
    public CastPid copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new CastPid(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public CastPid copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new CastPid(), deepcopy, con);
    }
     ...
     */
    protected CastPid copyInto(CastPid copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastPid copyInto(CastPid copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected CastPid copyInto(CastPid copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastPid copyInto(CastPid copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setCastId(castId);
        copyObj.setDirectName(directName);
    ...
    {
        return CastPidPeer.getTableMap();
    }

  
    /**
     * Creates a CastPidBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a CastPidBean with the contents of this object
     */
    public CastPidBean getBean()
    {
     ...
     * @return a CastPidBean with the contents of this object
     */
    public CastPidBean getBean(IdentityMap createdBeans)
    {
        CastPidBean result = (CastPidBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new CastPidBean();
    ...
    /**
     * Creates an instance of CastPid with the contents
     * of a CastPidBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the CastPidBean which contents are used to create
     *        the resulting class
     * @return an instance of CastPid with the contents of bean
     */
    public static CastPid createCastPid(CastPidBean bean)
        throws TorqueException
    {
        return createCastPid(bean, new IdentityMap());
    }
    ...
    public static CastPid createCastPid(CastPidBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        CastPid result = (CastPid) createdObjects.get(bean);
        if (result != null)
        {
