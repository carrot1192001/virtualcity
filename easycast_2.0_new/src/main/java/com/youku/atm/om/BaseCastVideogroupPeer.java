 ...
 *
 */
public abstract class BaseCastVideogroupPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(CastVideogroupMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(CastVideogroupMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "cast_videogroup";

        ID = "cast_videogroup.id";
        CAST_ID = "cast_videogroup.cast_id";
        DIRECT_NAME = "cast_videogroup.direct_name";
        DIRECT_VALUE = "cast_videogroup.direct_value";
        IS_POSITIVE = "cast_videogroup.is_positive";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(CastVideogroupMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(CastVideogroupMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.atm.om.CastVideogroup";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastVideogroup> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static CastVideogroup row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            CastVideogroup obj = (CastVideogroup) cls.newInstance();
            CastVideogroupPeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastVideogroup> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastVideogroup> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastVideogroup> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<CastVideogroup> results = new ArrayList<CastVideogroup>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(CastVideogroupPeer.row2Object(row, 1,
                CastVideogroupPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastVideogroup> doSelect(CastVideogroup obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastVideogroup obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastVideogroup obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastVideogroup obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(CastVideogroup) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastVideogroup obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(CastVideogroup) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastVideogroup obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(CastVideogroup) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastVideogroup obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( CastVideogroup obj )
    {
    ...
    public static Criteria buildSelectCriteria( CastVideogroup obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static CastVideogroup retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastVideogroup retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastVideogroup retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        CastVideogroup retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastVideogroup retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<CastVideogroup> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastVideogroup> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<CastVideogroup> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastVideogroup> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<CastVideogroup> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<CastVideogroup>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of CastVideogroup objects pre-filled with their
     * AdCast objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CastVideogroupPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastVideogroup> doSelectJoinAdCast(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastVideogroup> doSelectJoinAdCast(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        CastVideogroupPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        AdCastPeer.addSelectColumns(criteria);

        criteria.addJoin(CastVideogroupPeer.CAST_ID,
            AdCastPeer.ID);
        ...
        List<CastVideogroup> results = new ArrayList<CastVideogroup>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = CastVideogroupPeer.getOMClass();
            CastVideogroup obj1 = (CastVideogroup) CastVideogroupPeer
            ...
            {
                CastVideogroup temp_obj1 =  results.get(j);
                AdCast temp_obj2 = (AdCast) temp_obj1.getAdCast();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addCastVideogroup(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initCastVideogroups();
                obj2.addCastVideogroup(obj1);
            }
            results.add(obj1);
        }
        return results;
