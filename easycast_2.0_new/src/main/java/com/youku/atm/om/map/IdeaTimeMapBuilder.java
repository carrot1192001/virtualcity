 ...
 *
  */
public class IdeaTimeMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.youku.atm.om.map.IdeaTimeMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("idea_time");
        TableMap tMap = dbMap.getTable("idea_time");
        tMap.setJavaName("IdeaTime");
        tMap.setOMClass( com.youku.atm.om.IdeaTime.class );
        tMap.setPeerClass( com.youku.atm.om.IdeaTimePeer.class );
        tMap.setDescription("");
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("atm");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("idea_time_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("idea_time");
        }
