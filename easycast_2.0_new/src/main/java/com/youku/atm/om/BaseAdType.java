 ...
 * extended all references should be to AdType
 */
public abstract class BaseAdType extends BaseObject
{
    /** The Peer class */
    private static final AdTypePeer peer =
        new AdTypePeer();
    ...
    /** The value for the showType field */
    ...
    /**
     * Set the value of ShowType
     *
     * @param v new value
     */
    public void setShowType(int v) 
    {
     ...
     * Otherwise if this AdType has previously
    ...
    public List<AdCast> getAdCasts(Criteria criteria) throws TorqueException
    {
        if (collAdCasts == null)
        {
            ...
            {
                criteria.add(AdCastPeer.AD_TYPE_ID, getId() );
    ...
    public List<SdkConfig> getSdkConfigs(Criteria criteria) throws TorqueException
    {
        if (collSdkConfigs == null)
        {
            ...
            {
                criteria.add(SdkConfigPeer.AD_TYPE_ID, getId() );
    ...
    public List<SdkConfigLog> getSdkConfigLogs(Criteria criteria) throws TorqueException
    {
        if (collSdkConfigLogs == null)
        {
            ...
            {
                criteria.add(SdkConfigLogPeer.AD_TYPE_ID, getId() );
    ...
    public List<SdkLog> getSdkLogs(Criteria criteria) throws TorqueException
    {
        if (collSdkLogs == null)
        {
            ...
            {
                criteria.add(SdkLogPeer.AD_TYPE_ID, getId() );
    ...
    public Object getByName(String name)
    {
        ...
        {
            return new Integer(getShowType());
        }
        return null;
    }
        ...
        throws TorqueException, IllegalArgumentException
    {
        ...
        if (name.equals("ShowType"))
        {
            ...
            setShowType(((Integer) value).intValue());
            return true;
        }
        return false;
    }
    ...
    {
        if (name.equals(AdTypePeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(AdTypePeer.NAME))
        {
            return getName();
        }
        if (name.equals(AdTypePeer.STATUS))
        {
            return new Integer(getStatus());
        }
        if (name.equals(AdTypePeer.SHOW_TYPE))
        {
            return new Integer(getShowType());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (AdTypePeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (AdTypePeer.NAME.equals(name))
        {
            return setByName("Name", value);
        }
      if (AdTypePeer.STATUS.equals(name))
        {
            return setByName("Status", value);
        }
      if (AdTypePeer.SHOW_TYPE.equals(name))
        {
            return setByName("ShowType", value);
        }
        return false;
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    AdTypePeer.doInsert((AdType) this, con);
                    setNew(false);
                }
                else
                {
                    AdTypePeer.doUpdate((AdType) this, con);
                }
            }
     ...
     */
    public AdType copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public AdType copy(Connection con) throws TorqueException
    {
     ...
     */
    public AdType copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new AdType(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public AdType copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new AdType(), deepcopy, con);
    }
     ...
     */
    protected AdType copyInto(AdType copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected AdType copyInto(AdType copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected AdType copyInto(AdType copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setName(name);
        copyObj.setStatus(status);
        copyObj.setShowType(showType);
     ...
     * @param con the database connection to read associated objects.
     */
    protected AdType copyInto(AdType copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setName(name);
        copyObj.setStatus(status);
    ...
    {
        return AdTypePeer.getTableMap();
    }

  
    /**
     * Creates a AdTypeBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a AdTypeBean with the contents of this object
     */
    public AdTypeBean getBean()
    {
     ...
     * @return a AdTypeBean with the contents of this object
     */
    public AdTypeBean getBean(IdentityMap createdBeans)
    {
        AdTypeBean result = (AdTypeBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new AdTypeBean();
        createdBeans.put(this, result);

        result.setId(getId());
        result.setName(getName());
        result.setStatus(getStatus());
        result.setShowType(getShowType());
    ...
    /**
     * Creates an instance of AdType with the contents
     * of a AdTypeBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the AdTypeBean which contents are used to create
     *        the resulting class
     * @return an instance of AdType with the contents of bean
     */
    public static AdType createAdType(AdTypeBean bean)
        throws TorqueException
    {
        return createAdType(bean, new IdentityMap());
    }
    ...
    public static AdType createAdType(AdTypeBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        AdType result = (AdType) createdObjects.get(bean);
        if (result != null)
        {
        ...
        result.setShowType(bean.getShowType());
