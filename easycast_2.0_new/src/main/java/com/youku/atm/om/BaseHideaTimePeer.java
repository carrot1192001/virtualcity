 ...
 *
 */
public abstract class BaseHideaTimePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(HideaTimeMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(HideaTimeMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "hidea_time";

        ID = "hidea_time.id";
        IDEA_ID = "hidea_time.idea_id";
        STARTTIME = "hidea_time.startTime";
        ENDTIME = "hidea_time.endTime";
        DC_ID = "hidea_time.dc_id";
        STATUS = "hidea_time.status";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(HideaTimeMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(HideaTimeMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HideaTime> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static HideaTime row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            HideaTime obj = (HideaTime) cls.newInstance();
            HideaTimePeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HideaTime> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HideaTime> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HideaTime> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<HideaTime> results = new ArrayList<HideaTime>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(HideaTimePeer.row2Object(row, 1,
                HideaTimePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HideaTime> doSelect(HideaTime obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(HideaTime obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(HideaTime obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(HideaTime obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(HideaTime) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(HideaTime obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(HideaTime) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(HideaTime obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(HideaTime) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(HideaTime obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( HideaTime obj )
    {
    ...
    public static Criteria buildSelectCriteria( HideaTime obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static HideaTime retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static HideaTime retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static HideaTime retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        HideaTime retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static HideaTime retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<HideaTime> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HideaTime> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<HideaTime> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HideaTime> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<HideaTime> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<HideaTime>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of HideaTime objects pre-filled with their
     * Idea objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in HideaTimePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<HideaTime> doSelectJoinIdea(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<HideaTime> doSelectJoinIdea(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        HideaTimePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        IdeaPeer.addSelectColumns(criteria);

        criteria.addJoin(HideaTimePeer.IDEA_ID,
            IdeaPeer.ID);
        ...
        List<HideaTime> results = new ArrayList<HideaTime>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = HideaTimePeer.getOMClass();
            HideaTime obj1 = (HideaTime) HideaTimePeer
            ...
            {
                HideaTime temp_obj1 =  results.get(j);
                Idea temp_obj2 = (Idea) temp_obj1.getIdea();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addHideaTime(obj1);
                    break;
                }
            }
            if (newObject)
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<HideaTime> doSelectJoinDc(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<HideaTime> doSelectJoinDc(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(HideaTimePeer.DC_ID,
            DcPeer.ID);
