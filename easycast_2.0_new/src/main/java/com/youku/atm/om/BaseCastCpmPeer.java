 ...
 *
 */
public abstract class BaseCastCpmPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(CastCpmMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(CastCpmMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the cpm field */
    public static final String CPM;
    /** the column name for the cpc field */
    public static final String CPC;
    /** the column name for the lun field */
    public static final String LUN;
    /** the column name for the percent field */
    public static final String PERCENT;
    /** the column name for the cpv field */
    public static final String CPV;
    /** the column name for the cpp field */
    ...
    static
    {
        ...
        ID = "cast_cpm.id";
        CAST_ID = "cast_cpm.cast_id";
        CPM = "cast_cpm.cpm";
        CPC = "cast_cpm.cpc";
        LUN = "cast_cpm.lun";
        PERCENT = "cast_cpm.percent";
        CPV = "cast_cpm.cpv";
        CPP = "cast_cpm.cpp";
        DC_ID = "cast_cpm.dc_id";
        DC_ID2 = "cast_cpm.dc_id2";
        TARGET_DATE = "cast_cpm.target_date";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(CastCpmMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(CastCpmMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastCpm> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(CPM);
        criteria.addSelectColumn(CPC);
        criteria.addSelectColumn(LUN);
        criteria.addSelectColumn(PERCENT);
        criteria.addSelectColumn(CPV);
        criteria.addSelectColumn(CPP);
        criteria.addSelectColumn(DC_ID);
        criteria.addSelectColumn(DC_ID2);
        criteria.addSelectColumn(TARGET_DATE);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static CastCpm row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            CastCpm obj = (CastCpm) cls.newInstance();
            CastCpmPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setCpm(row.getValue(offset + 2).asInt());
            obj.setCpc(row.getValue(offset + 3).asInt());
            obj.setLun(row.getValue(offset + 4).asString());
            obj.setPercent(row.getValue(offset + 5).asInt());
            obj.setCpv(row.getValue(offset + 6).asInt());
            obj.setCpp(row.getValue(offset + 7).asInt());
            obj.setDcId(row.getValue(offset + 8).asInt());
            obj.setDcId2(row.getValue(offset + 9).asInt());
            obj.setTargetDate(row.getValue(offset + 10).asUtilDate());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastCpm> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastCpm> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastCpm> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<CastCpm> results = new ArrayList<CastCpm>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(CastCpmPeer.row2Object(row, 1,
                CastCpmPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastCpm> doSelect(CastCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastCpm obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(CastCpm) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(CastCpm obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(CastCpm) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(CastCpm obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(CastCpm) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(CastCpm obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( CastCpm obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(ID, obj.getId());
        criteria.add(CAST_ID, obj.getCastId());
        criteria.add(CPM, obj.getCpm());
        criteria.add(CPC, obj.getCpc());
        criteria.add(LUN, obj.getLun());
        criteria.add(PERCENT, obj.getPercent());
        criteria.add(CPV, obj.getCpv());
        criteria.add(CPP, obj.getCpp());
        criteria.add(DC_ID, obj.getDcId());
        criteria.add(DC_ID2, obj.getDcId2());
        criteria.add(TARGET_DATE, obj.getTargetDate());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( CastCpm obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static CastCpm retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastCpm retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastCpm retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        CastCpm retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static CastCpm retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<CastCpm> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastCpm> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<CastCpm> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<CastCpm> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<CastCpm> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<CastCpm>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of CastCpm objects pre-filled with their
     * AdCast objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CastCpmPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastCpm> doSelectJoinAdCast(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<CastCpm> doSelectJoinAdCast(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        CastCpmPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        AdCastPeer.addSelectColumns(criteria);

        criteria.addJoin(CastCpmPeer.CAST_ID,
            AdCastPeer.ID);
        ...
        List<CastCpm> results = new ArrayList<CastCpm>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = CastCpmPeer.getOMClass();
            CastCpm obj1 = (CastCpm) CastCpmPeer
            ...
            {
                CastCpm temp_obj1 =  results.get(j);
                AdCast temp_obj2 = (AdCast) temp_obj1.getAdCast();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addCastCpm(obj1);
                    break;
                }
            }
            if (newObject)
