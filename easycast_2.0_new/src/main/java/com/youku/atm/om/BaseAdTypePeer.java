 ...
 *
 */
public abstract class BaseAdTypePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(AdTypeMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(AdTypeMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the show_type field */
    ...
    static
    {
        ...
        SHOW_TYPE = "ad_type.show_type";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(AdTypeMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(AdTypeMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdType> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(SHOW_TYPE);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static AdType row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            AdType obj = (AdType) cls.newInstance();
            AdTypePeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setShowType(row.getValue(offset + 3).asInt());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdType> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdType> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdType> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<AdType> results = new ArrayList<AdType>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(AdTypePeer.row2Object(row, 1,
                AdTypePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdType> doSelect(AdType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(AdType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(AdType obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(AdType obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(AdType) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(AdType obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(AdType) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(AdType obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(AdType) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(AdType obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( AdType obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        criteria.add(ID, obj.getId());
        criteria.add(NAME, obj.getName());
        criteria.add(STATUS, obj.getStatus());
        criteria.add(SHOW_TYPE, obj.getShowType());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( AdType obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ID, obj.getId());
            criteria.add(NAME, obj.getName());
     ...
     */
    public static AdType retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static AdType retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static AdType retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        AdType retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static AdType retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<AdType> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdType> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<AdType> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdType> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<AdType> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<AdType>();
        }
        else
        {
            Criteria criteria = new Criteria();
