 ...
 *
 */
public abstract class BaseVhideaTimePeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(VhideaTimeMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(VhideaTimeMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "vhidea_time";

        ID = "vhidea_time.id";
        IDEA_ID = "vhidea_time.idea_id";
        STARTTIME = "vhidea_time.startTime";
        ENDTIME = "vhidea_time.endTime";
        DC_ID = "vhidea_time.dc_id";
        STATUS = "vhidea_time.status";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(VhideaTimeMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(VhideaTimeMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhideaTime> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static VhideaTime row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            VhideaTime obj = (VhideaTime) cls.newInstance();
            VhideaTimePeer.populateObject(row, offset, obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhideaTime> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhideaTime> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhideaTime> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<VhideaTime> results = new ArrayList<VhideaTime>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(VhideaTimePeer.row2Object(row, 1,
                VhideaTimePeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhideaTime> doSelect(VhideaTime obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(VhideaTime obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(VhideaTime obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(VhideaTime obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(VhideaTime) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(VhideaTime obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(VhideaTime) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(VhideaTime obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(VhideaTime) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(VhideaTime obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( VhideaTime obj )
    {
    ...
    public static Criteria buildSelectCriteria( VhideaTime obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static VhideaTime retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VhideaTime retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VhideaTime retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        VhideaTime retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VhideaTime retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<VhideaTime> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhideaTime> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<VhideaTime> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhideaTime> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<VhideaTime> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<VhideaTime>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of VhideaTime objects pre-filled with their
     * Idea objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in VhideaTimePeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<VhideaTime> doSelectJoinIdea(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<VhideaTime> doSelectJoinIdea(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        VhideaTimePeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        IdeaPeer.addSelectColumns(criteria);

        criteria.addJoin(VhideaTimePeer.IDEA_ID,
            IdeaPeer.ID);
        ...
        List<VhideaTime> results = new ArrayList<VhideaTime>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = VhideaTimePeer.getOMClass();
            VhideaTime obj1 = (VhideaTime) VhideaTimePeer
            ...
            {
                VhideaTime temp_obj1 =  results.get(j);
                Idea temp_obj2 = (Idea) temp_obj1.getIdea();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addVhideaTime(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initVhideaTimes();
                obj2.addVhideaTime(obj1);
            }
            results.add(obj1);
        }
        return results;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<VhideaTime> doSelectJoinDc(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinDc(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<VhideaTime> doSelectJoinDc(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(VhideaTimePeer.DC_ID,
            DcPeer.ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            {
                VhideaTime temp_obj1 =  results.get(j);
                Dc temp_obj2 = (Dc) temp_obj1.getDc();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addVhideaTime(obj1);
