 ...
 *
 */
public abstract class BaseSdkLogPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(SdkLogMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(SdkLogMapBuilder.CLASS_NAME);
    }

    /** the column name for the id field */
    public static final String ID;
    /** the column name for the sdk_device_id field */
    public static final String SDK_DEVICE_ID;
    ...
    /** the column name for the filling_rate field */
    public static final String FILLING_RATE;
    /** the column name for the show_num field */
    public static final String SHOW_NUM;
    /** the column name for the click_num field */
    public static final String CLICK_NUM;
    /** the column name for the income field */
    public static final String INCOME;
    /** the column name for the atmshow field */
    public static final String ATMSHOW;
    ...
    static
    {
        ...
        ID = "sdk_log.id";
        SDK_DEVICE_ID = "sdk_log.sdk_device_id";
        AD_TYPE_ID = "sdk_log.ad_type_id";
        SDK_ID = "sdk_log.sdk_id";
        FILLING_RATE = "sdk_log.filling_rate";
        SHOW_NUM = "sdk_log.show_num";
        CLICK_NUM = "sdk_log.click_num";
        INCOME = "sdk_log.income";
        ATMSHOW = "sdk_log.atmshow";
        CAST_ID = "sdk_log.cast_id";
        IDEA_ID = "sdk_log.idea_id";
        CREATE_DATE = "sdk_log.create_date";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(SdkLogMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(SdkLogMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkLog> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(SDK_DEVICE_ID);
        criteria.addSelectColumn(AD_TYPE_ID);
        criteria.addSelectColumn(SDK_ID);
        criteria.addSelectColumn(FILLING_RATE);
        criteria.addSelectColumn(SHOW_NUM);
        criteria.addSelectColumn(CLICK_NUM);
        criteria.addSelectColumn(INCOME);
        criteria.addSelectColumn(ATMSHOW);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static SdkLog row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            SdkLog obj = (SdkLog) cls.newInstance();
            SdkLogPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setSdkDeviceId(row.getValue(offset + 1).asInt());
            obj.setAdTypeId(row.getValue(offset + 2).asInt());
            obj.setSdkId(row.getValue(offset + 3).asInt());
            obj.setFillingRate(row.getValue(offset + 4).asDouble());
            obj.setShowNum(row.getValue(offset + 5).asInt());
            obj.setClickNum(row.getValue(offset + 6).asInt());
            obj.setIncome(row.getValue(offset + 7).asDouble());
            obj.setAtmshow(row.getValue(offset + 8).asInt());
            obj.setCastId(row.getValue(offset + 9).asInt());
            obj.setIdeaId(row.getValue(offset + 10).asInt());
            obj.setCreateDate(row.getValue(offset + 11).asUtilDate());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkLog> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkLog> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkLog> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<SdkLog> results = new ArrayList<SdkLog>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(SdkLogPeer.row2Object(row, 1,
                SdkLogPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkLog> doSelect(SdkLog obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SdkLog obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SdkLog obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SdkLog obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(SdkLog) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SdkLog obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(SdkLog) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SdkLog obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(SdkLog) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SdkLog obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( SdkLog obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(ID, obj.getId());
        criteria.add(SDK_DEVICE_ID, obj.getSdkDeviceId());
        criteria.add(AD_TYPE_ID, obj.getAdTypeId());
        criteria.add(SDK_ID, obj.getSdkId());
        criteria.add(FILLING_RATE, obj.getFillingRate());
        criteria.add(SHOW_NUM, obj.getShowNum());
        criteria.add(CLICK_NUM, obj.getClickNum());
        criteria.add(INCOME, obj.getIncome());
        criteria.add(ATMSHOW, obj.getAtmshow());
    ...
    public static Criteria buildSelectCriteria( SdkLog obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static SdkLog retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SdkLog retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SdkLog retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        SdkLog retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SdkLog retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<SdkLog> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkLog> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<SdkLog> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<SdkLog> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<SdkLog> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<SdkLog>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of SdkLog objects pre-filled with their
     * SdkDevice objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SdkLogPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkLog> doSelectJoinSdkDevice(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkLog> doSelectJoinSdkDevice(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        SdkLogPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        SdkDevicePeer.addSelectColumns(criteria);

        criteria.addJoin(SdkLogPeer.SDK_DEVICE_ID,
            SdkDevicePeer.ID);
        ...
        List<SdkLog> results = new ArrayList<SdkLog>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = SdkLogPeer.getOMClass();
            SdkLog obj1 = (SdkLog) SdkLogPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkLog> doSelectJoinAdType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkLog> doSelectJoinAdType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(SdkLogPeer.AD_TYPE_ID,
            AdTypePeer.ID);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkLog> doSelectJoinSdkName(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkLog> doSelectJoinSdkName(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        criteria.addJoin(SdkLogPeer.SDK_ID,
            SdkNamePeer.ID);
    ...
    /**
     * selects a collection of SdkLog objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkLog> doSelectJoinAllExceptSdkDevice(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkLog> doSelectJoinAllExceptSdkDevice(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        AdTypePeer.addSelectColumns(criteria);
        criteria.addJoin(SdkLogPeer.AD_TYPE_ID, AdTypePeer.ID);
        int offset3 = offset2 + AdTypePeer.numColumns;

        SdkNamePeer.addSelectColumns(criteria);
        criteria.addJoin(SdkLogPeer.SDK_ID, SdkNamePeer.ID);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkLog> doSelectJoinAllExceptAdType(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkLog> doSelectJoinAllExceptAdType(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        SdkDevicePeer.addSelectColumns(criteria);
        criteria.addJoin(SdkLogPeer.SDK_DEVICE_ID, SdkDevicePeer.ID);
 ...
 newObject = true;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkLog> doSelectJoinAllExceptSdkName(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<SdkLog> doSelectJoinAllExceptSdkName(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
