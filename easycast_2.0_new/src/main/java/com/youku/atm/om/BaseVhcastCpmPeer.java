 ...
 *
 */
public abstract class BaseVhcastCpmPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(VhcastCpmMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(VhcastCpmMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "vhcast_cpm";

        ID = "vhcast_cpm.id";
        CAST_ID = "vhcast_cpm.cast_id";
        CPM = "vhcast_cpm.cpm";
        CPC = "vhcast_cpm.cpc";
        LUN = "vhcast_cpm.lun";
        PERCENT = "vhcast_cpm.percent";
        TARGET_DATE = "vhcast_cpm.target_date";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(VhcastCpmMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(VhcastCpmMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhcastCpm> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static VhcastCpm row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            VhcastCpm obj = (VhcastCpm) cls.newInstance();
            VhcastCpmPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setTargetDate(row.getValue(offset + 6).asUtilDate());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhcastCpm> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhcastCpm> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhcastCpm> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<VhcastCpm> results = new ArrayList<VhcastCpm>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(VhcastCpmPeer.row2Object(row, 1,
                VhcastCpmPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhcastCpm> doSelect(VhcastCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(VhcastCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(VhcastCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(VhcastCpm obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(VhcastCpm) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(VhcastCpm obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(VhcastCpm) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(VhcastCpm obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(VhcastCpm) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(VhcastCpm obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( VhcastCpm obj )
    {
    ...
    public static Criteria buildSelectCriteria( VhcastCpm obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static VhcastCpm retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VhcastCpm retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VhcastCpm retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        VhcastCpm retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static VhcastCpm retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<VhcastCpm> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhcastCpm> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<VhcastCpm> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<VhcastCpm> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<VhcastCpm> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<VhcastCpm>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of VhcastCpm objects pre-filled with their
     * AdCast objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in VhcastCpmPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<VhcastCpm> doSelectJoinAdCast(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<VhcastCpm> doSelectJoinAdCast(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        VhcastCpmPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        AdCastPeer.addSelectColumns(criteria);

        criteria.addJoin(VhcastCpmPeer.CAST_ID,
            AdCastPeer.ID);
        ...
        List<VhcastCpm> results = new ArrayList<VhcastCpm>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = VhcastCpmPeer.getOMClass();
            VhcastCpm obj1 = (VhcastCpm) VhcastCpmPeer
            ...
            {
                VhcastCpm temp_obj1 =  results.get(j);
                AdCast temp_obj2 = (AdCast) temp_obj1.getAdCast();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addVhcastCpm(obj1);
                    break;
                }
            }
            if (newObject)
