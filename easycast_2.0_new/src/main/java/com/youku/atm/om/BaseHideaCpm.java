 ...
 * extended all references should be to HideaCpm
 */
public abstract class BaseHideaCpm extends BaseObject
{
    /** The Peer class */
    private static final HideaCpmPeer peer =
        new HideaCpmPeer();
    ...
    {
        if (name.equals(HideaCpmPeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(HideaCpmPeer.IDEA_ID))
        {
            return new Integer(getIdeaId());
        }
        if (name.equals(HideaCpmPeer.CPM))
        {
            return new Integer(getCpm());
        }
        if (name.equals(HideaCpmPeer.CPC))
        {
            return new Integer(getCpc());
        }
        if (name.equals(HideaCpmPeer.RATE))
        {
            return new Integer(getRate());
        }
        if (name.equals(HideaCpmPeer.TARGET_DATE))
        {
            return getTargetDate();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (HideaCpmPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (HideaCpmPeer.IDEA_ID.equals(name))
        {
            return setByName("IdeaId", value);
        }
      if (HideaCpmPeer.CPM.equals(name))
        {
            return setByName("Cpm", value);
        }
      if (HideaCpmPeer.CPC.equals(name))
        {
            return setByName("Cpc", value);
        }
      if (HideaCpmPeer.RATE.equals(name))
        {
            return setByName("Rate", value);
        }
      if (HideaCpmPeer.TARGET_DATE.equals(name))
        {
    ...
    {
        save(HideaCpmPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    HideaCpmPeer.doInsert((HideaCpm) this, con);
                    setNew(false);
                }
                else
                {
                    HideaCpmPeer.doUpdate((HideaCpm) this, con);
                }
            }
     ...
     */
    public HideaCpm copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public HideaCpm copy(Connection con) throws TorqueException
    {
     ...
     */
    public HideaCpm copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new HideaCpm(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public HideaCpm copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new HideaCpm(), deepcopy, con);
    }
     ...
     */
    protected HideaCpm copyInto(HideaCpm copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected HideaCpm copyInto(HideaCpm copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected HideaCpm copyInto(HideaCpm copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected HideaCpm copyInto(HideaCpm copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setIdeaId(ideaId);
        copyObj.setCpm(cpm);
    ...
    {
        return HideaCpmPeer.getTableMap();
    }

  
    /**
     * Creates a HideaCpmBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a HideaCpmBean with the contents of this object
     */
    public HideaCpmBean getBean()
    {
     ...
     * @return a HideaCpmBean with the contents of this object
     */
    public HideaCpmBean getBean(IdentityMap createdBeans)
    {
        HideaCpmBean result = (HideaCpmBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new HideaCpmBean();
    ...
    /**
     * Creates an instance of HideaCpm with the contents
     * of a HideaCpmBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the HideaCpmBean which contents are used to create
     *        the resulting class
     * @return an instance of HideaCpm with the contents of bean
     */
    public static HideaCpm createHideaCpm(HideaCpmBean bean)
        throws TorqueException
    {
        return createHideaCpm(bean, new IdentityMap());
    }
    ...
    public static HideaCpm createHideaCpm(HideaCpmBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        HideaCpm result = (HideaCpm) createdObjects.get(bean);
        if (result != null)
        {
