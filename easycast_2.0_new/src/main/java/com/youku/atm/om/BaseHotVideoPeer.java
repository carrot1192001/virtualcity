 ...
 *
 */
public abstract class BaseHotVideoPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(HotVideoMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(HotVideoMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the expired_ime field */
    public static final String EXPIRED_IME;
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "hot_video";

        ID = "hot_video.id";
        NAME = "hot_video.name";
        URL = "hot_video.url";
        STATUS = "hot_video.status";
        UPDATE_TIME = "hot_video.update_time";
        EXPIRED_IME = "hot_video.expired_ime";
        DESCRIPTION = "hot_video.description";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(HotVideoMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(HotVideoMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HotVideo> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(EXPIRED_IME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static HotVideo row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            HotVideo obj = (HotVideo) cls.newInstance();
            HotVideoPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setExpiredIme(row.getValue(offset + 5).asUtilDate());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HotVideo> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HotVideo> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HotVideo> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<HotVideo> results = new ArrayList<HotVideo>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(HotVideoPeer.row2Object(row, 1,
                HotVideoPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HotVideo> doSelect(HotVideo obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(HotVideo obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(HotVideo obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(HotVideo obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(HotVideo) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(HotVideo obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(HotVideo) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(HotVideo obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(HotVideo) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(HotVideo obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( HotVideo obj )
    {
        ...
        criteria.add(EXPIRED_IME, obj.getExpiredIme());
        criteria.add(DESCRIPTION, obj.getDescription());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( HotVideo obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ID, obj.getId());
            criteria.add(NAME, obj.getName());
     ...
     */
    public static HotVideo retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static HotVideo retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static HotVideo retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        HotVideo retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static HotVideo retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<HotVideo> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HotVideo> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<HotVideo> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<HotVideo> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<HotVideo> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<HotVideo>();
        }
        else
        {
            Criteria criteria = new Criteria();
