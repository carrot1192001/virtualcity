 ...
 * extended all references should be to CastScene
 */
public abstract class BaseCastScene extends BaseObject
{
    /** The Peer class */
    private static final CastScenePeer peer =
        new CastScenePeer();
    ...
    {
        if (name.equals(CastScenePeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(CastScenePeer.CAST_ID))
        {
            return new Integer(getCastId());
        }
        if (name.equals(CastScenePeer.DIRECT_NAME))
        {
            return getDirectName();
        }
        if (name.equals(CastScenePeer.DIRECT_VALUE))
        {
            return getDirectValue();
        }
        if (name.equals(CastScenePeer.IS_POSITIVE))
        {
            return new Integer(getIsPositive());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (CastScenePeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (CastScenePeer.CAST_ID.equals(name))
        {
            return setByName("CastId", value);
        }
      if (CastScenePeer.DIRECT_NAME.equals(name))
        {
            return setByName("DirectName", value);
        }
      if (CastScenePeer.DIRECT_VALUE.equals(name))
        {
            return setByName("DirectValue", value);
        }
      if (CastScenePeer.IS_POSITIVE.equals(name))
        {
    ...
    {
        save(CastScenePeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    CastScenePeer.doInsert((CastScene) this, con);
                    setNew(false);
                }
                else
                {
                    CastScenePeer.doUpdate((CastScene) this, con);
                }
            }
     ...
     */
    public CastScene copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public CastScene copy(Connection con) throws TorqueException
    {
     ...
     */
    public CastScene copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new CastScene(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public CastScene copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new CastScene(), deepcopy, con);
    }
     ...
     */
    protected CastScene copyInto(CastScene copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastScene copyInto(CastScene copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected CastScene copyInto(CastScene copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastScene copyInto(CastScene copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setCastId(castId);
        copyObj.setDirectName(directName);
    ...
    {
        return CastScenePeer.getTableMap();
    }

  
    /**
     * Creates a CastSceneBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a CastSceneBean with the contents of this object
     */
    public CastSceneBean getBean()
    {
     ...
     * @return a CastSceneBean with the contents of this object
     */
    public CastSceneBean getBean(IdentityMap createdBeans)
    {
        CastSceneBean result = (CastSceneBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new CastSceneBean();
    ...
    /**
     * Creates an instance of CastScene with the contents
     * of a CastSceneBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the CastSceneBean which contents are used to create
     *        the resulting class
     * @return an instance of CastScene with the contents of bean
     */
    public static CastScene createCastScene(CastSceneBean bean)
        throws TorqueException
    {
        return createCastScene(bean, new IdentityMap());
    }
    ...
    public static CastScene createCastScene(CastSceneBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        CastScene result = (CastScene) createdObjects.get(bean);
        if (result != null)
        {
            // we already have an object for the bean, return it
            return result;
        }
        result = new CastScene();
