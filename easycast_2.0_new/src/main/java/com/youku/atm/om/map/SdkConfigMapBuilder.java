 ...
 *
  */
public class SdkConfigMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.youku.atm.om.map.SdkConfigMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("sdk_config");
        TableMap tMap = dbMap.getTable("sdk_config");
        tMap.setJavaName("SdkConfig");
        tMap.setOMClass( com.youku.atm.om.SdkConfig.class );
        tMap.setPeerClass( com.youku.atm.om.SdkConfigPeer.class );
        tMap.setDescription("");
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("atm");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("sdk_config_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("sdk_config");
        }
  ...
  // ------------- Column: status --------------------
        ...
        cMap.setPosition(5);
        tMap.addColumn(cMap);
  // ------------- Column: manual_percent --------------------
        cMap = new ColumnMap( "manual_percent", tMap);
        cMap.setType( new Integer(0) );
        cMap.setTorqueType( "INTEGER" );
        cMap.setUsePrimitive(true);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(true);
        cMap.setJavaName( "ManualPercent" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("");
        cMap.setDefault("0");
        ...
        tMap.addColumn(cMap);
  // ------------- Column: auto_percent --------------------
        cMap = new ColumnMap( "auto_percent", tMap);
        cMap.setType( new Integer(0) );
        cMap.setTorqueType( "INTEGER" );
        cMap.setUsePrimitive(true);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(true);
        cMap.setJavaName( "AutoPercent" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("");
        cMap.setDefault("0");
