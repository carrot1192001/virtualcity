 ...
 *
  */
public class HotVideoMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.youku.atm.om.map.HotVideoMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("hot_video");
        TableMap tMap = dbMap.getTable("hot_video");
        tMap.setJavaName("HotVideo");
        tMap.setOMClass( com.youku.atm.om.HotVideo.class );
        tMap.setPeerClass( com.youku.atm.om.HotVideoPeer.class );
        tMap.setDescription("");
  ...
  // ------------- Column: update_time --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: expired_ime --------------------
        cMap = new ColumnMap( "expired_ime", tMap);
        cMap.setType( new Date() );
        cMap.setTorqueType( "TIMESTAMP" );
        cMap.setUsePrimitive(true);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(true);
        cMap.setJavaName( "ExpiredIme" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("");
        cMap.setInheritance("false");
