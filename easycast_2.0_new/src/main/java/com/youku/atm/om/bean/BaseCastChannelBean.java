 ...
 * extended; all references should be to CastChannelBean
 */
public abstract class BaseCastChannelBean
    implements Serializable
{
    ...
    private ChannelBean aChannelBean;

    /**
     * sets an associated ChannelBean object
     *
     * @param v ChannelBean
     */
    public void setChannelBean(ChannelBean v)
    {
        if (v == null)
        {
    ...
    /**
     * Get the associated ChannelBean object
     *
     * @return the associated ChannelBean object
     */
