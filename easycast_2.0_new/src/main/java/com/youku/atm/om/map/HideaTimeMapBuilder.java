 ...
 *
  */
public class HideaTimeMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.youku.atm.om.map.HideaTimeMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("hidea_time");
        TableMap tMap = dbMap.getTable("hidea_time");
        tMap.setJavaName("HideaTime");
        tMap.setOMClass( com.youku.atm.om.HideaTime.class );
        tMap.setPeerClass( com.youku.atm.om.HideaTimePeer.class );
        tMap.setDescription("");
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("atm");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("hidea_time_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("hidea_time");
        }
