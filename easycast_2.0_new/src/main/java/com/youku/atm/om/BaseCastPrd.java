 ...
 * extended all references should be to CastPrd
 */
public abstract class BaseCastPrd extends BaseObject
{
    /** The Peer class */
    private static final CastPrdPeer peer =
        new CastPrdPeer();
    ...
    {
        if (name.equals(CastPrdPeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(CastPrdPeer.CAST_ID))
        {
            return new Integer(getCastId());
        }
        if (name.equals(CastPrdPeer.DIRECT_NAME))
        {
            return getDirectName();
        }
        if (name.equals(CastPrdPeer.DIRECT_VALUE))
        {
            return getDirectValue();
        }
        if (name.equals(CastPrdPeer.IS_POSITIVE))
        {
            return new Integer(getIsPositive());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (CastPrdPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (CastPrdPeer.CAST_ID.equals(name))
        {
            return setByName("CastId", value);
        }
      if (CastPrdPeer.DIRECT_NAME.equals(name))
        {
            return setByName("DirectName", value);
        }
      if (CastPrdPeer.DIRECT_VALUE.equals(name))
        {
            return setByName("DirectValue", value);
        }
      if (CastPrdPeer.IS_POSITIVE.equals(name))
        {
    ...
    {
        save(CastPrdPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    CastPrdPeer.doInsert((CastPrd) this, con);
                    setNew(false);
                }
                else
                {
                    CastPrdPeer.doUpdate((CastPrd) this, con);
                }
            }
     ...
     */
    public CastPrd copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public CastPrd copy(Connection con) throws TorqueException
    {
     ...
     */
    public CastPrd copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new CastPrd(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public CastPrd copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new CastPrd(), deepcopy, con);
    }
     ...
     */
    protected CastPrd copyInto(CastPrd copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastPrd copyInto(CastPrd copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected CastPrd copyInto(CastPrd copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastPrd copyInto(CastPrd copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setCastId(castId);
        copyObj.setDirectName(directName);
    ...
    {
        return CastPrdPeer.getTableMap();
    }

  
    /**
     * Creates a CastPrdBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a CastPrdBean with the contents of this object
     */
    public CastPrdBean getBean()
    {
     ...
     * @return a CastPrdBean with the contents of this object
     */
    public CastPrdBean getBean(IdentityMap createdBeans)
    {
        CastPrdBean result = (CastPrdBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new CastPrdBean();
    ...
    /**
     * Creates an instance of CastPrd with the contents
     * of a CastPrdBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the CastPrdBean which contents are used to create
     *        the resulting class
     * @return an instance of CastPrd with the contents of bean
     */
    public static CastPrd createCastPrd(CastPrdBean bean)
        throws TorqueException
    {
        return createCastPrd(bean, new IdentityMap());
    }
    ...
    public static CastPrd createCastPrd(CastPrdBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        CastPrd result = (CastPrd) createdObjects.get(bean);
        if (result != null)
        {
