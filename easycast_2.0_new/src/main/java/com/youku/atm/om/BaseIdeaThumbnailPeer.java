 ...
 *
 */
public abstract class BaseIdeaThumbnailPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(IdeaThumbnailMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(IdeaThumbnailMapBuilder.CLASS_NAME);
    }

    /** the column name for the id field */
    public static final String ID;
    /** the column name for the thumbnail_id field */
    public static final String THUMBNAIL_ID;
    /** the column name for the idea_url_id field */
    public static final String IDEA_URL_ID;
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "idea_thumbnail";

        ID = "idea_thumbnail.id";
        THUMBNAIL_ID = "idea_thumbnail.thumbnail_id";
        IDEA_URL_ID = "idea_thumbnail.idea_url_id";
        TITLE = "idea_thumbnail.title";
        THUMBNAIL_URL = "idea_thumbnail.thumbnail_url";
        UPDATE_TIME = "idea_thumbnail.update_time";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(IdeaThumbnailMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(IdeaThumbnailMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.atm.om.IdeaThumbnail";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaThumbnail> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(THUMBNAIL_ID);
        criteria.addSelectColumn(IDEA_URL_ID);
        criteria.addSelectColumn(TITLE);
        criteria.addSelectColumn(THUMBNAIL_URL);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static IdeaThumbnail row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            IdeaThumbnail obj = (IdeaThumbnail) cls.newInstance();
            IdeaThumbnailPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setThumbnailId(row.getValue(offset + 1).asString());
            obj.setIdeaUrlId(row.getValue(offset + 2).asInt());
            obj.setTitle(row.getValue(offset + 3).asString());
            obj.setThumbnailUrl(row.getValue(offset + 4).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaThumbnail> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaThumbnail> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaThumbnail> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<IdeaThumbnail> results = new ArrayList<IdeaThumbnail>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(IdeaThumbnailPeer.row2Object(row, 1,
                IdeaThumbnailPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaThumbnail> doSelect(IdeaThumbnail obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(IdeaThumbnail obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(IdeaThumbnail obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(IdeaThumbnail obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(IdeaThumbnail) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(IdeaThumbnail obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(IdeaThumbnail) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(IdeaThumbnail obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(IdeaThumbnail) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(IdeaThumbnail obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( IdeaThumbnail obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(ID, obj.getId());
        criteria.add(THUMBNAIL_ID, obj.getThumbnailId());
        criteria.add(IDEA_URL_ID, obj.getIdeaUrlId());
        criteria.add(TITLE, obj.getTitle());
        criteria.add(THUMBNAIL_URL, obj.getThumbnailUrl());
        criteria.add(UPDATE_TIME, obj.getUpdateTime());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( IdeaThumbnail obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static IdeaThumbnail retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaThumbnail retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaThumbnail retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        IdeaThumbnail retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaThumbnail retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<IdeaThumbnail> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaThumbnail> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<IdeaThumbnail> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaThumbnail> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<IdeaThumbnail> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<IdeaThumbnail>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of IdeaThumbnail objects pre-filled with their
     * IdeaUrl objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in IdeaThumbnailPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<IdeaThumbnail> doSelectJoinIdeaUrl(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinIdeaUrl(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<IdeaThumbnail> doSelectJoinIdeaUrl(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        IdeaThumbnailPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        IdeaUrlPeer.addSelectColumns(criteria);

        criteria.addJoin(IdeaThumbnailPeer.IDEA_URL_ID,
            IdeaUrlPeer.ID);
        ...
        List<IdeaThumbnail> results = new ArrayList<IdeaThumbnail>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = IdeaThumbnailPeer.getOMClass();
            IdeaThumbnail obj1 = (IdeaThumbnail) IdeaThumbnailPeer
                .row2Object(row, 1, omClass);
             omClass = IdeaUrlPeer.getOMClass();
            IdeaUrl obj2 = (IdeaUrl) IdeaUrlPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                IdeaThumbnail temp_obj1 =  results.get(j);
                IdeaUrl temp_obj2 = (IdeaUrl) temp_obj1.getIdeaUrl();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addIdeaThumbnail(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initIdeaThumbnails();
                obj2.addIdeaThumbnail(obj1);
            }
            results.add(obj1);
        }
        return results;
