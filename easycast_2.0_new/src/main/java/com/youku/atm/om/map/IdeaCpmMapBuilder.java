 ...
 *
  */
public class IdeaCpmMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.youku.atm.om.map.IdeaCpmMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("idea_cpm");
        TableMap tMap = dbMap.getTable("idea_cpm");
        tMap.setJavaName("IdeaCpm");
        tMap.setOMClass( com.youku.atm.om.IdeaCpm.class );
        tMap.setPeerClass( com.youku.atm.om.IdeaCpmPeer.class );
        tMap.setDescription("");
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("atm");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("idea_cpm_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("idea_cpm");
        }
