 ...
 * extended all references should be to SdkDevice
 */
public abstract class BaseSdkDevice extends BaseObject
{
    /** The Peer class */
    private static final SdkDevicePeer peer =
        new SdkDevicePeer();
     ...
     * Otherwise if this SdkDevice has previously
     * been saved, it will retrieve related SdkConfigs from storage.
     * If this SdkDevice is new, it will return
    ...
    public List<SdkConfig> getSdkConfigs(Criteria criteria) throws TorqueException
    {
        if (collSdkConfigs == null)
        {
            ...
            {
                criteria.add(SdkConfigPeer.DEVICE_ID, getId() );
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this SdkDevice is new, it will return
     * an empty collection; or if this SdkDevice has previously
     * been saved, it will retrieve related SdkConfigs from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SdkDevice.
     */
    ...
    public List<SdkConfigLog> getSdkConfigLogs(Criteria criteria) throws TorqueException
    {
        if (collSdkConfigLogs == null)
        {
            ...
            {
                criteria.add(SdkConfigLogPeer.DEVICE_ID, getId() );
    ...
    public List<SdkLog> getSdkLogs(Criteria criteria) throws TorqueException
    {
        if (collSdkLogs == null)
        {
            ...
            {
                criteria.add(SdkLogPeer.SDK_DEVICE_ID, getId() );
    ...
    {
        if (name.equals(SdkDevicePeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(SdkDevicePeer.NAME))
        {
            return getName();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (SdkDevicePeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (SdkDevicePeer.NAME.equals(name))
        {
    ...
    {
        save(SdkDevicePeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    SdkDevicePeer.doInsert((SdkDevice) this, con);
                    setNew(false);
                }
                else
                {
                    SdkDevicePeer.doUpdate((SdkDevice) this, con);
                }
            }
     ...
     */
    public SdkDevice copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public SdkDevice copy(Connection con) throws TorqueException
    {
     ...
     */
    public SdkDevice copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new SdkDevice(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public SdkDevice copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new SdkDevice(), deepcopy, con);
    }
     ...
     */
    protected SdkDevice copyInto(SdkDevice copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected SdkDevice copyInto(SdkDevice copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected SdkDevice copyInto(SdkDevice copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected SdkDevice copyInto(SdkDevice copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setName(name);
    ...
    {
        return SdkDevicePeer.getTableMap();
    }

  
    /**
     * Creates a SdkDeviceBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a SdkDeviceBean with the contents of this object
     */
    public SdkDeviceBean getBean()
    {
     ...
     * @return a SdkDeviceBean with the contents of this object
     */
    public SdkDeviceBean getBean(IdentityMap createdBeans)
    {
        SdkDeviceBean result = (SdkDeviceBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new SdkDeviceBean();
    ...
    /**
     * Creates an instance of SdkDevice with the contents
     * of a SdkDeviceBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the SdkDeviceBean which contents are used to create
     *        the resulting class
     * @return an instance of SdkDevice with the contents of bean
     */
    public static SdkDevice createSdkDevice(SdkDeviceBean bean)
        throws TorqueException
    {
        return createSdkDevice(bean, new IdentityMap());
    }
    ...
    public static SdkDevice createSdkDevice(SdkDeviceBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        SdkDevice result = (SdkDevice) createdObjects.get(bean);
        if (result != null)
        {
            // we already have an object for the bean, return it
            return result;
        }
        result = new SdkDevice();
