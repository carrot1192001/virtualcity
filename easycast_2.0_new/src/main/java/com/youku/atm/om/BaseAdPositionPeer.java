 ...
 *
 */
public abstract class BaseAdPositionPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(AdPositionMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(AdPositionMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the pos_sub_type field */
    public static final String POS_SUB_TYPE;
    /** the column name for the req_point field */
    public static final String REQ_POINT;
    /** the column name for the page_comment field */
    public static final String PAGE_COMMENT;
    /** the column name for the place field */
    public static final String PLACE;
    /** the column name for the page_size field */
    public static final String PAGE_SIZE;
    /** the column name for the template field */
    public static final String TEMPLATE;
    /** the column name for the seq_num field */
    public static final String SEQ_NUM;
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "ad_position";

        ID = "ad_position.id";
        NAME = "ad_position.name";
        MEDIA = "ad_position.media";
        DEVICE = "ad_position.device";
        TYPE = "ad_position.type";
        POS_TYPE = "ad_position.pos_type";
        POS_SUB_TYPE = "ad_position.pos_sub_type";
        REQ_POINT = "ad_position.req_point";
        PAGE_COMMENT = "ad_position.page_comment";
        PLACE = "ad_position.place";
        PAGE_SIZE = "ad_position.page_size";
        TEMPLATE = "ad_position.template";
        SEQ_NUM = "ad_position.seq_num";
        OLD_ID = "ad_position.old_id";
        VALUE = "ad_position.value";
        UPDATE_TIME = "ad_position.update_time";
        STATUS = "ad_position.status";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(AdPositionMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(AdPositionMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdPosition> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(MEDIA);
        criteria.addSelectColumn(DEVICE);
        criteria.addSelectColumn(TYPE);
        criteria.addSelectColumn(POS_TYPE);
        criteria.addSelectColumn(POS_SUB_TYPE);
        criteria.addSelectColumn(REQ_POINT);
        criteria.addSelectColumn(PAGE_COMMENT);
        criteria.addSelectColumn(PLACE);
        criteria.addSelectColumn(PAGE_SIZE);
        criteria.addSelectColumn(TEMPLATE);
        criteria.addSelectColumn(SEQ_NUM);
        criteria.addSelectColumn(OLD_ID);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static AdPosition row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            AdPosition obj = (AdPosition) cls.newInstance();
            AdPositionPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setMedia(row.getValue(offset + 2).asString());
            obj.setDevice(row.getValue(offset + 3).asString());
            obj.setType(row.getValue(offset + 4).asString());
            obj.setPosType(row.getValue(offset + 5).asString());
            obj.setPosSubType(row.getValue(offset + 6).asString());
            obj.setReqPoint(row.getValue(offset + 7).asString());
            obj.setPageComment(row.getValue(offset + 8).asString());
            obj.setPlace(row.getValue(offset + 9).asString());
            obj.setPageSize(row.getValue(offset + 10).asString());
            obj.setTemplate(row.getValue(offset + 11).asString());
            obj.setSeqNum(row.getValue(offset + 12).asString());
            obj.setOldId(row.getValue(offset + 13).asString());
            obj.setValue(row.getValue(offset + 14).asString());
            obj.setUpdateTime(row.getValue(offset + 15).asString());
            obj.setStatus(row.getValue(offset + 16).asString());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdPosition> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdPosition> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdPosition> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<AdPosition> results = new ArrayList<AdPosition>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(AdPositionPeer.row2Object(row, 1,
                AdPositionPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdPosition> doSelect(AdPosition obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(AdPosition obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(AdPosition obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(AdPosition obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(AdPosition) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(AdPosition obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(AdPosition) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(AdPosition obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(AdPosition) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(AdPosition obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( AdPosition obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        criteria.add(ID, obj.getId());
        criteria.add(NAME, obj.getName());
        criteria.add(MEDIA, obj.getMedia());
        criteria.add(DEVICE, obj.getDevice());
        criteria.add(TYPE, obj.getType());
        criteria.add(POS_TYPE, obj.getPosType());
        criteria.add(POS_SUB_TYPE, obj.getPosSubType());
        criteria.add(REQ_POINT, obj.getReqPoint());
        criteria.add(PAGE_COMMENT, obj.getPageComment());
        criteria.add(PLACE, obj.getPlace());
        criteria.add(PAGE_SIZE, obj.getPageSize());
        criteria.add(TEMPLATE, obj.getTemplate());
        criteria.add(SEQ_NUM, obj.getSeqNum());
        criteria.add(OLD_ID, obj.getOldId());
    ...
    public static Criteria buildSelectCriteria( AdPosition obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static AdPosition retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static AdPosition retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static AdPosition retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        AdPosition retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static AdPosition retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<AdPosition> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdPosition> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<AdPosition> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<AdPosition> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<AdPosition> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<AdPosition>();
        }
        else
        {
            Criteria criteria = new Criteria();
