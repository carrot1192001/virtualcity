 ...
 * extended; all references should be to CastPlatformBean
 */
public abstract class BaseCastPlatformBean
    implements Serializable
{
    ...
    private PlatformBean aPlatformBean;

    /**
     * sets an associated PlatformBean object
     *
     * @param v PlatformBean
     */
    public void setPlatformBean(PlatformBean v)
    {
        if (v == null)
        {
    ...
    /**
     * Get the associated PlatformBean object
     *
     * @return the associated PlatformBean object
     */
    public PlatformBean getPlatformBean()
    {
        return aPlatformBean;
    }
