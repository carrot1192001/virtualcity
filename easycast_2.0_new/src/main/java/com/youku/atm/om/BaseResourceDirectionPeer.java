 ...
 *
 */
public abstract class BaseResourceDirectionPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(ResourceDirectionMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(ResourceDirectionMapBuilder.CLASS_NAME);
    }
    ...
    {
        DATABASE_NAME = "atm";
        TABLE_NAME = "resource_direction";

        ID = "resource_direction.id";
        RESOURCE_ID = "resource_direction.resource_id";
        NAME = "resource_direction.name";
        VALUE = "resource_direction.value";
        IS_POSITIVE = "resource_direction.is_positive";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(ResourceDirectionMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(ResourceDirectionMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.youku.atm.om.ResourceDirection";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ResourceDirection> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
    ...
    public static ObjectKey doInsert(Criteria criteria)
        throws TorqueException
    {
        return BaseResourceDirectionPeer
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static ResourceDirection row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            ResourceDirection obj = (ResourceDirection) cls.newInstance();
            ResourceDirectionPeer.populateObject(row, offset, obj);
    ...
    public static void populateObject(Record row,
                                      int offset,
                                      ResourceDirection obj)
        throws TorqueException
    {
        try
        {
            obj.setId(row.getValue(offset + 0).asInt());
            obj.setResourceId(row.getValue(offset + 1).asInt());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ResourceDirection> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ResourceDirection> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ResourceDirection> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<ResourceDirection> results = new ArrayList<ResourceDirection>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(ResourceDirectionPeer.row2Object(row, 1,
                ResourceDirectionPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ResourceDirection> doSelect(ResourceDirection obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(ResourceDirection obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(ResourceDirection obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(ResourceDirection obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(ResourceDirection) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(ResourceDirection obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(ResourceDirection) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(ResourceDirection obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(ResourceDirection) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(ResourceDirection obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( ResourceDirection obj )
    {
    ...
    public static Criteria buildSelectCriteria( ResourceDirection obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static ResourceDirection retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static ResourceDirection retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static ResourceDirection retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        ResourceDirection retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static ResourceDirection retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<ResourceDirection> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
        ...
        {
            return (ResourceDirection)v.get(0);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ResourceDirection> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<ResourceDirection> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<ResourceDirection> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<ResourceDirection> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<ResourceDirection>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of ResourceDirection objects pre-filled with their
     * Resource objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ResourceDirectionPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<ResourceDirection> doSelectJoinResource(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<ResourceDirection> doSelectJoinResource(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        ResourceDirectionPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        ResourcePeer.addSelectColumns(criteria);

        criteria.addJoin(ResourceDirectionPeer.RESOURCE_ID,
            ResourcePeer.ID);
        ...
        List<ResourceDirection> results = new ArrayList<ResourceDirection>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = ResourceDirectionPeer.getOMClass();
            ResourceDirection obj1 = (ResourceDirection) ResourceDirectionPeer
            ...
            {
                ResourceDirection temp_obj1 =  results.get(j);
                Resource temp_obj2 = (Resource) temp_obj1.getResource();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addResourceDirection(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initResourceDirections();
                obj2.addResourceDirection(obj1);
            }
            results.add(obj1);
        }
        return results;
