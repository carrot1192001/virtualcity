 ...
 * extended; all references should be to CastAreaBean
 */
public abstract class BaseCastAreaBean
    implements Serializable
{
    ...
    private AreaBean aAreaBean;

    /**
     * sets an associated AreaBean object
     *
     * @param v AreaBean
     */
    public void setAreaBean(AreaBean v)
    {
        if (v == null)
        {
    ...
    /**
     * Get the associated AreaBean object
     *
     * @return the associated AreaBean object
     */
