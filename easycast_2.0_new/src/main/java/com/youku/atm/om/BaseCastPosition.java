 ...
 * extended all references should be to CastPosition
 */
public abstract class BaseCastPosition extends BaseObject
{
    /** The Peer class */
    private static final CastPositionPeer peer =
        new CastPositionPeer();
    ...
    {
        if (name.equals(CastPositionPeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(CastPositionPeer.CAST_ID))
        {
            return new Integer(getCastId());
        }
        if (name.equals(CastPositionPeer.DIRECT_NAME))
        {
            return getDirectName();
        }
        if (name.equals(CastPositionPeer.DIRECT_VALUE))
        {
            return getDirectValue();
        }
        if (name.equals(CastPositionPeer.MUTEX))
        {
            return new Integer(getMutex());
        }
        if (name.equals(CastPositionPeer.IS_POSITIVE))
        {
            return new Integer(getIsPositive());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (CastPositionPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (CastPositionPeer.CAST_ID.equals(name))
        {
            return setByName("CastId", value);
        }
      if (CastPositionPeer.DIRECT_NAME.equals(name))
        {
            return setByName("DirectName", value);
        }
      if (CastPositionPeer.DIRECT_VALUE.equals(name))
        {
            return setByName("DirectValue", value);
        }
      if (CastPositionPeer.MUTEX.equals(name))
        {
            return setByName("Mutex", value);
        }
      if (CastPositionPeer.IS_POSITIVE.equals(name))
        {
    ...
    {
        save(CastPositionPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    CastPositionPeer.doInsert((CastPosition) this, con);
                    setNew(false);
                }
                else
                {
                    CastPositionPeer.doUpdate((CastPosition) this, con);
                }
            }
     ...
     */
    public CastPosition copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public CastPosition copy(Connection con) throws TorqueException
    {
     ...
     */
    public CastPosition copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new CastPosition(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public CastPosition copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new CastPosition(), deepcopy, con);
    }
     ...
     */
    protected CastPosition copyInto(CastPosition copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastPosition copyInto(CastPosition copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected CastPosition copyInto(CastPosition copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastPosition copyInto(CastPosition copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setCastId(castId);
        copyObj.setDirectName(directName);
     ...
     */
    public CastPositionPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return CastPositionPeer.getTableMap();
    }

  
    /**
     * Creates a CastPositionBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a CastPositionBean with the contents of this object
     */
    public CastPositionBean getBean()
    {
     ...
     * @return a CastPositionBean with the contents of this object
     */
    public CastPositionBean getBean(IdentityMap createdBeans)
    {
        CastPositionBean result = (CastPositionBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new CastPositionBean();
    ...
    /**
     * Creates an instance of CastPosition with the contents
     * of a CastPositionBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the CastPositionBean which contents are used to create
     *        the resulting class
     * @return an instance of CastPosition with the contents of bean
     */
    public static CastPosition createCastPosition(CastPositionBean bean)
        throws TorqueException
    {
        return createCastPosition(bean, new IdentityMap());
    }
    ...
    public static CastPosition createCastPosition(CastPositionBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        CastPosition result = (CastPosition) createdObjects.get(bean);
        if (result != null)
        {
            // we already have an object for the bean, return it
            return result;
        }
        result = new CastPosition();
