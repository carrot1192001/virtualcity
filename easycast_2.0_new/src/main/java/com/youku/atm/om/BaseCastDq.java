 ...
 * extended all references should be to CastDq
 */
public abstract class BaseCastDq extends BaseObject
{
    /** The Peer class */
    private static final CastDqPeer peer =
        new CastDqPeer();
    ...
    {
        if (name.equals(CastDqPeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(CastDqPeer.CAST_ID))
        {
            return new Integer(getCastId());
        }
        if (name.equals(CastDqPeer.DIRECT_NAME))
        {
            return getDirectName();
        }
        if (name.equals(CastDqPeer.DIRECT_VALUE))
        {
            return getDirectValue();
        }
        if (name.equals(CastDqPeer.IS_POSITIVE))
        {
            return new Integer(getIsPositive());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (CastDqPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (CastDqPeer.CAST_ID.equals(name))
        {
            return setByName("CastId", value);
        }
      if (CastDqPeer.DIRECT_NAME.equals(name))
        {
            return setByName("DirectName", value);
        }
      if (CastDqPeer.DIRECT_VALUE.equals(name))
        {
            return setByName("DirectValue", value);
        }
      if (CastDqPeer.IS_POSITIVE.equals(name))
        {
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    CastDqPeer.doInsert((CastDq) this, con);
                    setNew(false);
                }
                else
                {
                    CastDqPeer.doUpdate((CastDq) this, con);
                }
            }
     ...
     */
    public CastDq copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public CastDq copy(Connection con) throws TorqueException
    {
     ...
     */
    public CastDq copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new CastDq(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public CastDq copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new CastDq(), deepcopy, con);
    }
     ...
     */
    protected CastDq copyInto(CastDq copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastDq copyInto(CastDq copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected CastDq copyInto(CastDq copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastDq copyInto(CastDq copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setCastId(castId);
        copyObj.setDirectName(directName);
    ...
    {
        return CastDqPeer.getTableMap();
    }

  
    /**
     * Creates a CastDqBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a CastDqBean with the contents of this object
     */
    public CastDqBean getBean()
    {
     ...
     * @return a CastDqBean with the contents of this object
     */
    public CastDqBean getBean(IdentityMap createdBeans)
    {
        CastDqBean result = (CastDqBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new CastDqBean();
    ...
    /**
     * Creates an instance of CastDq with the contents
     * of a CastDqBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the CastDqBean which contents are used to create
     *        the resulting class
     * @return an instance of CastDq with the contents of bean
     */
    public static CastDq createCastDq(CastDqBean bean)
        throws TorqueException
    {
        return createCastDq(bean, new IdentityMap());
    }
    ...
    public static CastDq createCastDq(CastDqBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        CastDq result = (CastDq) createdObjects.get(bean);
        if (result != null)
        {
