 ...
 *
 */
public abstract class BaseIdeaCpmPeer
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(IdeaCpmMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(IdeaCpmMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        ID = "idea_cpm.id";
        IDEA_ID = "idea_cpm.idea_id";
        CPM = "idea_cpm.cpm";
        CPC = "idea_cpm.cpc";
        RATE = "idea_cpm.rate";
        CPV = "idea_cpm.cpv";
        CPP = "idea_cpm.cpp";
        TARGET_DATE = "idea_cpm.target_date";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(IdeaCpmMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(IdeaCpmMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaCpm> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static IdeaCpm row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            IdeaCpm obj = (IdeaCpm) cls.newInstance();
            IdeaCpmPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setRate(row.getValue(offset + 4).asInt());
            obj.setCpv(row.getValue(offset + 5).asInt());
            obj.setCpp(row.getValue(offset + 6).asInt());
            obj.setTargetDate(row.getValue(offset + 7).asUtilDate());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaCpm> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaCpm> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaCpm> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<IdeaCpm> results = new ArrayList<IdeaCpm>(records.size());

        // populate the object(s)
        for (int i = 0; i < records.size(); i++)
        {
            Record row =  records.get(i);
            results.add(IdeaCpmPeer.row2Object(row, 1,
                IdeaCpmPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaCpm> doSelect(IdeaCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(IdeaCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(IdeaCpm obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(IdeaCpm obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(IdeaCpm) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(IdeaCpm obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(IdeaCpm) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(IdeaCpm obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(IdeaCpm) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(IdeaCpm obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( IdeaCpm obj )
    {
    ...
    public static Criteria buildSelectCriteria( IdeaCpm obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static IdeaCpm retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaCpm retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaCpm retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        IdeaCpm retVal = null;
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static IdeaCpm retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<IdeaCpm> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaCpm> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<IdeaCpm> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<IdeaCpm> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<IdeaCpm> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<IdeaCpm>();
        }
        else
        {
            Criteria criteria = new Criteria();
    ...
    /**
     * selects a collection of IdeaCpm objects pre-filled with their
     * Idea objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in IdeaCpmPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<IdeaCpm> doSelectJoinIdea(Criteria criteria)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List<IdeaCpm> doSelectJoinIdea(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        IdeaCpmPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        IdeaPeer.addSelectColumns(criteria);

        criteria.addJoin(IdeaCpmPeer.IDEA_ID,
            IdeaPeer.ID);
        ...
        List<IdeaCpm> results = new ArrayList<IdeaCpm>();

        for (int i = 0; i < rows.size(); i++)
        {
            Record row =  rows.get(i);

            Class omClass = IdeaCpmPeer.getOMClass();
            IdeaCpm obj1 = (IdeaCpm) IdeaCpmPeer
            ...
            {
                IdeaCpm temp_obj1 =  results.get(j);
                Idea temp_obj2 = (Idea) temp_obj1.getIdea();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addIdeaCpm(obj1);
                    break;
                }
            }
            if (newObject)
