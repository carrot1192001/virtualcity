 ...
 * extended all references should be to CastPaid
 */
public abstract class BaseCastPaid extends BaseObject
{
    /** The Peer class */
    private static final CastPaidPeer peer =
        new CastPaidPeer();
    ...
    {
        if (name.equals(CastPaidPeer.ID))
        {
            return new Integer(getId());
        }
        if (name.equals(CastPaidPeer.CAST_ID))
        {
            return new Integer(getCastId());
        }
        if (name.equals(CastPaidPeer.DIRECT_NAME))
        {
            return getDirectName();
        }
        if (name.equals(CastPaidPeer.DIRECT_VALUE))
        {
            return getDirectValue();
        }
        if (name.equals(CastPaidPeer.IS_POSITIVE))
        {
            return new Integer(getIsPositive());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (CastPaidPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (CastPaidPeer.CAST_ID.equals(name))
        {
            return setByName("CastId", value);
        }
      if (CastPaidPeer.DIRECT_NAME.equals(name))
        {
            return setByName("DirectName", value);
        }
      if (CastPaidPeer.DIRECT_VALUE.equals(name))
        {
            return setByName("DirectValue", value);
        }
      if (CastPaidPeer.IS_POSITIVE.equals(name))
        {
    ...
    {
        save(CastPaidPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    CastPaidPeer.doInsert((CastPaid) this, con);
                    setNew(false);
                }
                else
                {
                    CastPaidPeer.doUpdate((CastPaid) this, con);
                }
            }
     ...
     */
    public CastPaid copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public CastPaid copy(Connection con) throws TorqueException
    {
     ...
     */
    public CastPaid copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new CastPaid(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public CastPaid copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new CastPaid(), deepcopy, con);
    }
     ...
     */
    protected CastPaid copyInto(CastPaid copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastPaid copyInto(CastPaid copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected CastPaid copyInto(CastPaid copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected CastPaid copyInto(CastPaid copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setCastId(castId);
        copyObj.setDirectName(directName);
    ...
    {
        return CastPaidPeer.getTableMap();
    }

  
    /**
     * Creates a CastPaidBean with the contents of this object
     * This also creates beans for cached related objects, if they exist
     * @return a CastPaidBean with the contents of this object
     */
    public CastPaidBean getBean()
    {
     ...
     * @return a CastPaidBean with the contents of this object
     */
    public CastPaidBean getBean(IdentityMap createdBeans)
    {
        CastPaidBean result = (CastPaidBean) createdBeans.get(this);
        if (result != null ) {
            // we have already created a bean for this object, return it
            return result;
        }
        // no bean exists for this object; create a new one
        result = new CastPaidBean();
    ...
    /**
     * Creates an instance of CastPaid with the contents
     * of a CastPaidBean.
     * This behaviour could have also been achieved using a constructor,
     * however as this class is abstract no constructors are allowed
     * @param bean the CastPaidBean which contents are used to create
     *        the resulting class
     * @return an instance of CastPaid with the contents of bean
     */
    public static CastPaid createCastPaid(CastPaidBean bean)
        throws TorqueException
    {
        return createCastPaid(bean, new IdentityMap());
    }
    ...
    public static CastPaid createCastPaid(CastPaidBean bean, IdentityMap createdObjects)
        throws TorqueException
    {
        CastPaid result = (CastPaid) createdObjects.get(bean);
        if (result != null)
        {
