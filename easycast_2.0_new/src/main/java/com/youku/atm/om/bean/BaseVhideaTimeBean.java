 ...
 * extended; all references should be to VhideaTimeBean
 */
public abstract class BaseVhideaTimeBean
    implements Serializable
{
     ...
     * @param v DcBean
     */
    public void setDcBean(DcBean v)
    {
        if (v == null)
        {
            setDcId( 0);
