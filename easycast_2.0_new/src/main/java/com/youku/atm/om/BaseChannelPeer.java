    ...
    extends BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(ChannelMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(ChannelMapBuilder.CLASS_NAME);
    }
    ...
    /** the column name for the is_hot field */
    public static final String IS_HOT;
    /** the column name for the status field */
    public static final String STATUS;
    /** the column name for the refvalue field */
    public static final String REFVALUE;
    ...
    static
    {
        ...
        REFVALUE = "channel.refvalue";
        DESCRIPTION = "channel.description";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(ChannelMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(ChannelMapBuilder.CLASS_NAME);
        }
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Channel> resultSet2Objects(java.sql.ResultSet results)
            throws TorqueException
    {
        try
        {
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(IS_HOT);
        criteria.addSelectColumn(STATUS);
        criteria.addSelectColumn(REFVALUE);
        ...
        throws TorqueException
    {
        try
        {
            ...
            ChannelPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            ...
            obj.setParentId(row.getValue(offset + 1).asString());
            obj.setType(row.getValue(offset + 2).asString());
            obj.setName(row.getValue(offset + 3).asString());
            obj.setIsHot(row.getValue(offset + 4).asInt());
            obj.setStatus(row.getValue(offset + 5).asInt());
            obj.setRefvalue(row.getValue(offset + 6).asString());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Channel> doSelect(Criteria criteria) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Channel> doSelect(Criteria criteria, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Channel> populateObjects(List<Record> records)
        throws TorqueException
    {
        List<Channel> results = new ArrayList<Channel>(records.size());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Channel> doSelect(Channel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Channel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Channel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Channel obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(Channel obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(Channel obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(Channel obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( Channel obj )
    {
        ...
        criteria.add(IS_HOT, obj.getIsHot());
        criteria.add(STATUS, obj.getStatus());
        criteria.add(REFVALUE, obj.getRefvalue());
        criteria.add(DESCRIPTION, obj.getDescription());
        return criteria;
    }

    /** Build a Criteria object from the data object for this peer, skipping all binary columns */
    public static Criteria buildSelectCriteria( Channel obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(ID, obj.getId());
            criteria.add(PARENT_ID, obj.getParentId());
     ...
     */
    public static Channel retrieveByPK(String pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Channel retrieveByPK(String pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static Channel retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Channel> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Channel> retrieveByPKs(List<ObjectKey> pks)
        throws TorqueException
    {
        Connection db = null;
        List<Channel> retVal = null;
        try
        {
           db = Torque.getConnection(DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Channel> retrieveByPKs( List<ObjectKey> pks, Connection dbcon )
        throws TorqueException
    {
        List<Channel> objs = null;
        if (pks == null || pks.size() == 0)
        {
            objs = new LinkedList<Channel>();
        }
        else
        {
            Criteria criteria = new Criteria();
